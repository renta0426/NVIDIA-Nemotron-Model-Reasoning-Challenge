# v20_corrective_corpus_v159_v157_numericcrypt9

- created_at: 2026-04-30T16:40:35.910166+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v157 post-ninth-BIT frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v157 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v159_v157_numericcrypt9_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v157 stack that already replayed the ninth crypt deduce pass.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the ninth post-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v159_v157_numericcrypt9_bundle.jsonl
- base_examples: 7830
- overlay_examples: 43975
- total_examples: 51805
- total_steps: 1620
- total_tokens: 39963408
- max_seq_len: 7971
