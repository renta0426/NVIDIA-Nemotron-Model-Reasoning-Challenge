# v20_corrective_corpus_v135_v133_numericcrypt5

- created_at: 2026-04-30T15:27:38.993486+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cipher`, `Bit Manipulation`, `Cryptarithm (Deduce)`, and `Cryptarithm (Guess)`. This branch keeps the v133 post-fifth-BIT deduce frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v133 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v135_v133_numericcrypt5_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v133 stack that already refreshed fifth-pass exact-safe BIT plus focused crypt deduce pressure.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the post-fifth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v135_v133_numericcrypt5_bundle.jsonl
- base_examples: 7830
- overlay_examples: 32887
- total_examples: 40717
- total_steps: 1273
- total_tokens: 36930832
- max_seq_len: 7971
