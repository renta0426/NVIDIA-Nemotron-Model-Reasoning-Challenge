# v20_corrective_corpus_v143_v141_bitrefresh7

- created_at: 2026-04-30T15:52:00.739378+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, and `Cryptarithm (Guess)`. This branch keeps the v141 post-seventh numeric frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v141 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v143_v141_bitrefresh7_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v141 stack that already replayed the seventh numeric pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the seventh numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v143_v141_bitrefresh7_bundle.jsonl
- base_examples: 7830
- overlay_examples: 37388
- total_examples: 45218
- total_steps: 1414
- total_tokens: 38284369
- max_seq_len: 7971
