# v20_corrective_corpus_v156_v154_bitrefresh9

- created_at: 2026-04-30T16:28:04.537106+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v154 post-ninth numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v154 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v156_v154_bitrefresh9_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v154 stack that already replayed the ninth numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v156_v154_bitrefresh9_bundle.jsonl
- base_examples: 7830
- overlay_examples: 41088
- total_examples: 48918
- total_steps: 1529
- total_tokens: 39596881
- max_seq_len: 7971
