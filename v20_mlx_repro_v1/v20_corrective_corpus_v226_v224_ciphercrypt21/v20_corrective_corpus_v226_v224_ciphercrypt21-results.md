# v20_corrective_corpus_v226_v224_ciphercrypt21

- created_at: 2026-04-30T21:07:26.086152+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v224 post-twentieth-crypt frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v224 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v226_v224_ciphercrypt21_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v224 stack that already replayed the latest cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the twentieth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v226_v224_ciphercrypt21_bundle.jsonl
- base_examples: 7830
- overlay_examples: 70259
- total_examples: 78089
- total_steps: 2441
- total_tokens: 47859300
- max_seq_len: 7971
