...
- status: bundle generated and MLX training is running; latest observed step is `35`, and model score is not yet measured.
- planned run name: `v20_mlx_v12_bit_binary_manual_heavy_mlxdir_mb1_nobc_ckpt20`
- runtime status: `running`
- latest observed step: `35`
- retained checkpoints: `0000020_adapters.safetensors`
- local300 score: TBD
