# v20_corrective_corpus_v129_v127_numericcrypt4

- created_at: 2026-04-30T14:54:28.785131+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v127 post-fourth-BIT deduce frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v127 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v129_v127_numericcrypt4_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v127 stack that already refreshed post-fourth-BIT deduce pressure.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the post-fourth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v129_v127_numericcrypt4_bundle.jsonl
- base_examples: 7830
- overlay_examples: 30115
- total_examples: 37945
- total_steps: 1187
- total_tokens: 36172688
- max_seq_len: 7971
