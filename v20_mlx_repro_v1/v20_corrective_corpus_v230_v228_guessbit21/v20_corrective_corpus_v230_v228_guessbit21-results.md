# v20_corrective_corpus_v230_v228_guessbit21

- created_at: 2026-04-30T21:33:04.413370+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v228 post-twenty-first-bit frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v228 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v230_v228_guessbit21_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v228 stack that already replayed the latest exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the twenty-first BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v230_v228_guessbit21_bundle.jsonl
- base_examples: 7830
- overlay_examples: 72590
- total_examples: 80420
- total_steps: 2514
- total_tokens: 48547517
- max_seq_len: 7971
