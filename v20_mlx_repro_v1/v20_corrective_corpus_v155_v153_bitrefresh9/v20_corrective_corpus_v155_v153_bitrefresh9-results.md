# v20_corrective_corpus_v155_v153_bitrefresh9

- created_at: 2026-04-30T16:27:35.329795+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v153 post-ninth numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v153 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v155_v153_bitrefresh9_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v153 stack that already replayed the ninth numeric/cipher pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the ninth numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v155_v153_bitrefresh9_bundle.jsonl
- base_examples: 7830
- overlay_examples: 42932
- total_examples: 50762
- total_steps: 1587
- total_tokens: 39800657
- max_seq_len: 7971
