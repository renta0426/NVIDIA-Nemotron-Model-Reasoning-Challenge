# v20_corrective_corpus_v174_v172_bitrefresh12

- created_at: 2026-04-30T17:35:13.757765+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v172 post-twelfth numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v172 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v174_v172_bitrefresh12_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v172 stack that already replayed the twelfth numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v174_v172_bitrefresh12_bundle.jsonl
- base_examples: 7830
- overlay_examples: 48813
- total_examples: 56643
- total_steps: 1771
- total_tokens: 41811334
- max_seq_len: 7971
