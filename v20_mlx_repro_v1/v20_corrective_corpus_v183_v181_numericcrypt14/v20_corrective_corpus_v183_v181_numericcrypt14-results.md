# v20_corrective_corpus_v183_v181_numericcrypt14

- created_at: 2026-04-30T18:16:58.108213+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v181 post-thirteenth-crypt frontier and adds one more numeric operator and quote replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v181 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v183_v181_numericcrypt14_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v181 stack that already replayed the thirteenth focused cryptarithm deduce pass.
- Add another numeric operator and quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the thirteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v183_v181_numericcrypt14_bundle.jsonl
- base_examples: 7830
- overlay_examples: 55063
- total_examples: 62893
- total_steps: 1966
- total_tokens: 42995984
- max_seq_len: 7971
