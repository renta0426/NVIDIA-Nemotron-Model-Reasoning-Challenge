# v20_corrective_corpus_v112_v110_ciphercrypt

- created_at: 2026-04-30T13:41:43.699758+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Equation Numeric (Guess)`. This branch keeps the v110 post-bit guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v110 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v112_v110_ciphercrypt_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v110 stack that already refreshed exact-safe BIT plus crypt guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-bit crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v112_v110_ciphercrypt_bundle.jsonl
- base_examples: 7830
- overlay_examples: 21334
- total_examples: 29164
- total_steps: 912
- total_tokens: 33834431
- max_seq_len: 7971
