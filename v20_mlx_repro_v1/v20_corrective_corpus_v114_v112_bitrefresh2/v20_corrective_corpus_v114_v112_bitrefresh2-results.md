# v20_corrective_corpus_v114_v112_bitrefresh2

- created_at: 2026-04-30T13:47:45.172391+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Equation Numeric (Guess)`. This branch keeps the v112 post-bit cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v112 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v114_v112_bitrefresh2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v112 stack that already refreshed post-bit cipher pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-bit cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v114_v112_bitrefresh2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 23063
- total_examples: 30893
- total_steps: 966
- total_tokens: 34429824
- max_seq_len: 7971
