# v20_corrective_corpus_v134_v132_guessbit5

- created_at: 2026-04-30T15:20:04.872058+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, `Cipher`, and `Equation Numeric (Guess)`. This branch keeps the v132 fifth-BIT-refresh frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v132 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v134_v132_guessbit5_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v132 stack that already refreshed fifth-pass exact-safe BIT pressure.
- Add another guess-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Guess)` slice after the fifth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v134_v132_guessbit5_bundle.jsonl
- base_examples: 7830
- overlay_examples: 31390
- total_examples: 39220
- total_steps: 1226
- total_tokens: 36737101
- max_seq_len: 7971
