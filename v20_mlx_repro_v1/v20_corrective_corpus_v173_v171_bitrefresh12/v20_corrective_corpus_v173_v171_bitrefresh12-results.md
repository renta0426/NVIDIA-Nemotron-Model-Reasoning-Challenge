# v20_corrective_corpus_v173_v171_bitrefresh12

- created_at: 2026-04-30T17:34:40.046152+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v171 post-twelfth numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v171 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v173_v171_bitrefresh12_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v171 stack that already replayed the twelfth numeric/cipher pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the twelfth numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v173_v171_bitrefresh12_bundle.jsonl
- base_examples: 7830
- overlay_examples: 51248
- total_examples: 59078
- total_steps: 1847
- total_tokens: 42075089
- max_seq_len: 7971
