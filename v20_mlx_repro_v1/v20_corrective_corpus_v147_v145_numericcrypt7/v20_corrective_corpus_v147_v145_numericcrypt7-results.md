# v20_corrective_corpus_v147_v145_numericcrypt7

- created_at: 2026-04-30T16:02:49.025737+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v145 post-seventh-BIT frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v145 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v147_v145_numericcrypt7_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v145 stack that already replayed the seventh crypt deduce pass.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the seventh post-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v147_v145_numericcrypt7_bundle.jsonl
- base_examples: 7830
- overlay_examples: 38431
- total_examples: 46261
- total_steps: 1446
- total_tokens: 38447120
- max_seq_len: 7971
