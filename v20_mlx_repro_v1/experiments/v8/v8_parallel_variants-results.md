...
- latest observed step: `5` (`Step 4/296: loss=0.013082 lr=0.00019797 tokens=127862 elapsed=8528.32s`; the current resumed run has only reached `Step 5/296: started` so newer loss lines from older log segments are ignored)
