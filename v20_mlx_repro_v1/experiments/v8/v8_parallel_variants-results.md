...
- MLX training: `v20_mlx_v8_bit_family_rebalance_broadbase_mlxdir_mb1_nobc_ckpt20` is now running under `v20_mlx_repro_v1/outputs/v8/` with detached supervisor, checkpoint cap (`save_every_steps=20`, `max_saved_checkpoints=3`), and README-style local300 watcher armed (`step 21` observed after manifest fix; first periodic checkpoint `0000020_adapters.safetensors` written)
- local300 score: TBD
