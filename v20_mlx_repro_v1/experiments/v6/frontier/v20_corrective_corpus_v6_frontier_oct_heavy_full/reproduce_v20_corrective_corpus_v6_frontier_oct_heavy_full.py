...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_oct_heavy_full"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build the v6 promptlocal-short-token-binary-support-hybrid-full-numeric-popular8-plain-cryptarithm-support-bit-miss-support-crypt-miss-support-measured-surface-support corrective corpus for the v20 Kaggle reproduction path, "
            "keeping the prompt-local full support base, keeping the full structured-byte answer-only support lane, "
    ...
    parser.add_argument("--run-name", default="v6_frontier_oct_heavy_full_default")
...
def main() -> None:
    ...
    report_lines = [
        "# v20 corrective corpus v6 promptlocal-short-token-binary-support-hybrid-full-numeric-popular8-plain-cryptarithm-support-bit-miss-support-crypt-miss-support-measured-surface-support report",
        "",
        "## Purpose",
        "",
        ...
        "adds a full prompt-local bit answer-only support lane plus a full structured-byte answer-only support lane,",
