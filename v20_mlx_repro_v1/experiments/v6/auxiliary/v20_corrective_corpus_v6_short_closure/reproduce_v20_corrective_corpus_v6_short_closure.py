...
RESULTS_MD = VERSION_ROOT / "v20_corrective_corpus_v6_short_closure-results.md"
...
DEFAULT_BUNDLE_PATH = TRAINING_SFT_ROOT / "v20_corrective_corpus_v6_short_closure_bundle.jsonl"
...
def build_summary(
    ...
    return {
        "version": "v20_corrective_corpus_v6_short_closure",
        "created_at": utc_now(),
...
def build_training_bundle(
    ...
    manifest = {
        ...
        "note": (
            ...
            "plus a v6-core exact-binary multi-lane overlay, a short-closure rewrite lane for binary and easy-family rows, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build the v6 short-closure corrective corpus for the v20 Kaggle reproduction path, "
            "keeping the v20 base, adding v6-core exact-binary overlays plus a short-closure rewrite lane, "
            "and retaining a minimal boxed-surface stabilizer lane."
        )
    )
    parser.add_argument("--run-name", default="v6_short_closure_default")
...
def main() -> None:
    ...
    report_lines = [
        "# v20 corrective corpus v6 short-closure report",
        "",
        "## Purpose",
        "",
