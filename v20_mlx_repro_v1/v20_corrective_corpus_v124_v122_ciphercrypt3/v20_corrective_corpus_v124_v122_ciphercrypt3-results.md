# v20_corrective_corpus_v124_v122_ciphercrypt3

- created_at: 2026-04-30T14:30:39.052810+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Equation Numeric (Guess)`. This branch keeps the v122 post-third-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v122 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v124_v122_ciphercrypt3_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v122 stack that already refreshed third-pass exact-safe BIT plus crypt guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-third-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v124_v122_ciphercrypt3_bundle.jsonl
- base_examples: 7830
- overlay_examples: 26484
- total_examples: 34314
- total_steps: 1073
- total_tokens: 35310733
- max_seq_len: 7971
