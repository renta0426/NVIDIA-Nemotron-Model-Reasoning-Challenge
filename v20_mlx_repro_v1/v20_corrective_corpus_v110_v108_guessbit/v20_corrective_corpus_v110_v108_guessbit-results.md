# v20_corrective_corpus_v110_v108_guessbit

- created_at: 2026-04-30T13:34:43.147079+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, `Equation Numeric (Guess)`, and `Cipher`. This branch keeps the v108 BIT-refreshed frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v108 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v110_v108_guessbit_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v108 stack that already refreshed numeric, cipher, and exact-safe BIT pressure.
- Add another guess-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Guess)` slice after the BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v110_v108_guessbit_bundle.jsonl
- base_examples: 7830
- overlay_examples: 21090
- total_examples: 28920
- total_steps: 905
- total_tokens: 33784497
- max_seq_len: 7971
