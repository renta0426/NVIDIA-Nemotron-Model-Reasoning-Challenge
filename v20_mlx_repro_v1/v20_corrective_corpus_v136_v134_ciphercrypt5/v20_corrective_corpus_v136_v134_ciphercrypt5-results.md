# v20_corrective_corpus_v136_v134_ciphercrypt5

- created_at: 2026-04-30T15:28:03.661133+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Equation Numeric (Guess)`, `Bit Manipulation`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v134 post-fifth-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v134 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v136_v134_ciphercrypt5_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v134 stack that already refreshed fifth-pass exact-safe BIT plus crypt guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-fifth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v136_v134_ciphercrypt5_bundle.jsonl
- base_examples: 7830
- overlay_examples: 31634
- total_examples: 39464
- total_steps: 1234
- total_tokens: 36787035
- max_seq_len: 7971
