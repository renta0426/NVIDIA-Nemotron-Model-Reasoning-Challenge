# v20_corrective_corpus_v137_v135_bitrefresh6

- created_at: 2026-04-30T15:33:30.765451+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cipher`, `Cryptarithm (Deduce)`, and `Cryptarithm (Guess)`. This branch keeps the v135 post-sixth numeric frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v135 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v137_v135_bitrefresh6_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v135 stack that already refreshed post-sixth numeric pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-sixth numeric refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v137_v135_bitrefresh6_bundle.jsonl
- base_examples: 7830
- overlay_examples: 34616
- total_examples: 42446
- total_steps: 1327
- total_tokens: 37526225
- max_seq_len: 7971
