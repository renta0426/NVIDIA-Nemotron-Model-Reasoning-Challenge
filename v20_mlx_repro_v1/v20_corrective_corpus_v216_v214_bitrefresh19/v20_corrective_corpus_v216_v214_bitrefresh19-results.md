# v20_corrective_corpus_v216_v214_bitrefresh19

- created_at: 2026-04-30T20:30:52.792603+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v214 post-nineteenth-cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v214 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v216_v214_bitrefresh19_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v214 stack that already replayed the latest hard-cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v216_v214_bitrefresh19_bundle.jsonl
- base_examples: 7830
- overlay_examples: 66838
- total_examples: 74668
- total_steps: 2334
- total_tokens: 46978391
- max_seq_len: 7971
