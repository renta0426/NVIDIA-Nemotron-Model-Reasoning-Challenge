# v20_corrective_corpus_v148_v146_ciphercrypt7

- created_at: 2026-04-30T16:02:47.958992+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v146 post-seventh-BIT frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v146 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v148_v146_ciphercrypt7_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v146 stack that already replayed the seventh crypt guess pass.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the seventh post-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v148_v146_ciphercrypt7_bundle.jsonl
- base_examples: 7830
- overlay_examples: 36784
- total_examples: 44614
- total_steps: 1395
- total_tokens: 38263337
- max_seq_len: 7971
