# v20_corrective_corpus_v171_v169_numericcrypt11

- created_at: 2026-04-30T17:27:04.043606+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v169 post-eleventh-BIT deduce frontier and adds one more numeric operator and quote replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v169 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v171_v169_numericcrypt11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v169 stack that already replayed the eleventh post-BIT crypt deduce pass.
- Add another numeric operator and quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the eleventh crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v171_v169_numericcrypt11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 49519
- total_examples: 57349
- total_steps: 1793
- total_tokens: 41479696
- max_seq_len: 7971
