# v20_corrective_corpus_v123_v121_numericcrypt3

- created_at: 2026-04-30T14:30:16.950271+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v121 post-third-BIT deduce frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v121 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v123_v121_numericcrypt3_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v121 stack that already refreshed third-pass exact-safe BIT plus focused crypt deduce pressure.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the post-third-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v123_v121_numericcrypt3_bundle.jsonl
- base_examples: 7830
- overlay_examples: 27343
- total_examples: 35173
- total_steps: 1100
- total_tokens: 35414544
- max_seq_len: 7971
