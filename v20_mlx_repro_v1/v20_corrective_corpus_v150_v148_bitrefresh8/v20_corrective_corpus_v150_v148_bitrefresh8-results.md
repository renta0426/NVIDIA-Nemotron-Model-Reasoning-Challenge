# v20_corrective_corpus_v150_v148_bitrefresh8

- created_at: 2026-04-30T16:07:47.609926+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v148 post-eighth numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v148 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v150_v148_bitrefresh8_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v148 stack that already replayed the eighth numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v150_v148_bitrefresh8_bundle.jsonl
- base_examples: 7830
- overlay_examples: 38513
- total_examples: 46343
- total_steps: 1449
- total_tokens: 38858730
- max_seq_len: 7971
