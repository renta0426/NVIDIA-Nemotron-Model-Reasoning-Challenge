# v20_corrective_corpus_v190_v188_ciphercrypt15

- created_at: 2026-04-30T18:40:21.376545+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Bit Manipulation`. This branch keeps the v188 post-fourteenth-crypt frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v188 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v190_v188_ciphercrypt15_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v188 stack that already replayed the latest cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the fourteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v190_v188_ciphercrypt15_bundle.jsonl
- base_examples: 7830
- overlay_examples: 54809
- total_examples: 62639
- total_steps: 1958
- total_tokens: 43430394
- max_seq_len: 7971
