# v20_corrective_corpus_v142_v140_ciphercrypt6

- created_at: 2026-04-30T15:46:49.259268+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Equation Numeric (Guess)`, `Bit Manipulation`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v140 post-sixth-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v140 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v142_v140_ciphercrypt6_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v140 stack that already refreshed sixth-pass exact-safe BIT plus crypt guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-sixth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v142_v140_ciphercrypt6_bundle.jsonl
- base_examples: 7830
- overlay_examples: 34209
- total_examples: 42039
- total_steps: 1315
- total_tokens: 37525186
- max_seq_len: 7971
