# v20_corrective_corpus_v108_v106_bitrefresh

- created_at: 2026-04-30T13:29:45.317239+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cipher`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v106 numeric-and-cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v106 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v108_v106_bitrefresh_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v106 stack that already refreshed crypt, numeric, and cipher pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after mixed non-bit saturation.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v108_v106_bitrefresh_bundle.jsonl
- base_examples: 7830
- overlay_examples: 20488
- total_examples: 28318
- total_steps: 886
- total_tokens: 33691673
- max_seq_len: 7971
