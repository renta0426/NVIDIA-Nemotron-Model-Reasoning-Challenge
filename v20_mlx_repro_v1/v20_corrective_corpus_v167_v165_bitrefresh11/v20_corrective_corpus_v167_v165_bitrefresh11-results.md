# v20_corrective_corpus_v167_v165_bitrefresh11

- created_at: 2026-04-30T17:10:01.531944+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v165 post-eleventh numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v165 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v167_v165_bitrefresh11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v165 stack that already replayed the eleventh numeric/cipher pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the eleventh numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v167_v165_bitrefresh11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 48476
- total_examples: 56306
- total_steps: 1760
- total_tokens: 41316945
- max_seq_len: 7971
