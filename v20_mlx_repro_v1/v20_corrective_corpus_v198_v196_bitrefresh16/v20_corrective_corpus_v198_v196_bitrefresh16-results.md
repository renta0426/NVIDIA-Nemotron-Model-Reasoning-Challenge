# v20_corrective_corpus_v198_v196_bitrefresh16

- created_at: 2026-04-30T19:08:27.268502+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v196 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v196 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v198_v196_bitrefresh16_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v196 stack that already replayed the latest numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v198_v196_bitrefresh16_bundle.jsonl
- base_examples: 7830
- overlay_examples: 59113
- total_examples: 66943
- total_steps: 2093
- total_tokens: 44763938
- max_seq_len: 7971
