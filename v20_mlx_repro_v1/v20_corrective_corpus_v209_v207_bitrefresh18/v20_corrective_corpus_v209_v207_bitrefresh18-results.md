# v20_corrective_corpus_v209_v207_bitrefresh18

- created_at: 2026-04-30T19:58:01.037037+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v207 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v207 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v209_v207_bitrefresh18_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v207 stack that already replayed the latest numeric/cipher pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the eighteenth numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v209_v207_bitrefresh18_bundle.jsonl
- base_examples: 7830
- overlay_examples: 67880
- total_examples: 75710
- total_steps: 2367
- total_tokens: 46623953
- max_seq_len: 7971
