# v20_corrective_corpus_v132_v130_bitrefresh5

- created_at: 2026-04-30T15:13:58.088814+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Equation Numeric (Guess)`. This branch keeps the v130 post-fifth cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v130 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v132_v130_bitrefresh5_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v130 stack that already refreshed post-fifth cipher pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-fifth cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v132_v130_bitrefresh5_bundle.jsonl
- base_examples: 7830
- overlay_examples: 30788
- total_examples: 38618
- total_steps: 1208
- total_tokens: 36644277
- max_seq_len: 7971
