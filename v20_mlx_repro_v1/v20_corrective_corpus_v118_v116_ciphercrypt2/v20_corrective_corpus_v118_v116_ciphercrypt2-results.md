# v20_corrective_corpus_v118_v116_ciphercrypt2

- created_at: 2026-04-30T14:11:17.393635+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Equation Numeric (Guess)`. This branch keeps the v116 post-second-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v116 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v118_v116_ciphercrypt2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v116 stack that already refreshed second-pass exact-safe BIT plus crypt guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-second-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v118_v116_ciphercrypt2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 23909
- total_examples: 31739
- total_steps: 993
- total_tokens: 34572582
- max_seq_len: 7971
