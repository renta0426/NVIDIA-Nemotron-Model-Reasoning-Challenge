# v20_corrective_corpus_v182_v180_guessbit13

- created_at: 2026-04-30T18:09:26.388492+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v180 post-thirteenth-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v180 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v182_v180_guessbit13_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v180 stack that already replayed the thirteenth exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the thirteenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v182_v180_guessbit13_bundle.jsonl
- base_examples: 7830
- overlay_examples: 51990
- total_examples: 59820
- total_steps: 1870
- total_tokens: 42642309
- max_seq_len: 7971
