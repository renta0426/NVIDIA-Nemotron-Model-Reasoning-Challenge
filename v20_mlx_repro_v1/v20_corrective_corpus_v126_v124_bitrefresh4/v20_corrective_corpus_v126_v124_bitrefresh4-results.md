# v20_corrective_corpus_v126_v124_bitrefresh4

- created_at: 2026-04-30T14:39:12.491399+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Equation Numeric (Guess)`. This branch keeps the v124 post-third-BIT cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v124 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v126_v124_bitrefresh4_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v124 stack that already refreshed post-third-BIT cipher pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-third-BIT cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v126_v124_bitrefresh4_bundle.jsonl
- base_examples: 7830
- overlay_examples: 28213
- total_examples: 36043
- total_steps: 1127
- total_tokens: 35906126
- max_seq_len: 7971
