# v20_corrective_corpus_v115_v113_deducebit2

- created_at: 2026-04-30T13:53:39.493680+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, `Equation Numeric (Guess)`, and `Cipher`. This branch keeps the v113 second-BIT-refresh frontier and adds one more focused cryptarithm-deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v113 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v115_v113_deducebit2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v113 stack that already refreshed second-pass exact-safe BIT pressure.
- Add another focused deduce-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the second BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v115_v113_deducebit2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 24305
- total_examples: 32135
- total_steps: 1005
- total_tokens: 34612880
- max_seq_len: 7971
