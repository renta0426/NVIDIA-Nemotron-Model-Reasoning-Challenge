# v20_corrective_corpus_v195_v193_numericcrypt16

- created_at: 2026-04-30T19:00:46.630198+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v193 post-fifteenth-crypt frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v193 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v195_v193_numericcrypt16_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v193 stack that already replayed the latest cryptarithm deduce pass.
- Add another numeric replay so the branch revisits the README `Equation Numeric (Guess)` slice after the fifteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v195_v193_numericcrypt16_bundle.jsonl
- base_examples: 7830
- overlay_examples: 60607
- total_examples: 68437
- total_steps: 2139
- total_tokens: 44512272
- max_seq_len: 7971
