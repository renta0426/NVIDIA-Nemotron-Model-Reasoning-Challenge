# v20_corrective_corpus_v125_v123_bitrefresh4

- created_at: 2026-04-30T14:38:49.548824+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, and `Cipher`. This branch keeps the v123 post-third-BIT numeric frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v123 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v125_v123_bitrefresh4_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v123 stack that already refreshed post-third-BIT numeric pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-third-BIT numeric refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v125_v123_bitrefresh4_bundle.jsonl
- base_examples: 7830
- overlay_examples: 29072
- total_examples: 36902
- total_steps: 1154
- total_tokens: 36009937
- max_seq_len: 7971
