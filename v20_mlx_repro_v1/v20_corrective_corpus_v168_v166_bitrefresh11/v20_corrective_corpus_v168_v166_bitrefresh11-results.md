# v20_corrective_corpus_v168_v166_bitrefresh11

- created_at: 2026-04-30T17:10:33.486712+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v166 post-eleventh numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v166 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v168_v166_bitrefresh11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v166 stack that already replayed the eleventh numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v168_v166_bitrefresh11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 46238
- total_examples: 54068
- total_steps: 1690
- total_tokens: 41073183
- max_seq_len: 7971
