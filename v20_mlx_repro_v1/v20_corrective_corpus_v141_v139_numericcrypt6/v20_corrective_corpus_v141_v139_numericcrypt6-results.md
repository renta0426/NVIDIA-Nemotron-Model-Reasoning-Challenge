# v20_corrective_corpus_v141_v139_numericcrypt6

- created_at: 2026-04-30T15:46:50.828226+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cipher`, `Bit Manipulation`, `Cryptarithm (Deduce)`, and `Cryptarithm (Guess)`. This branch keeps the v139 post-sixth-BIT deduce frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v139 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v141_v139_numericcrypt6_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v139 stack that already refreshed sixth-pass exact-safe BIT plus focused crypt deduce pressure.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the post-sixth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v141_v139_numericcrypt6_bundle.jsonl
- base_examples: 7830
- overlay_examples: 35659
- total_examples: 43489
- total_steps: 1360
- total_tokens: 37688976
- max_seq_len: 7971
