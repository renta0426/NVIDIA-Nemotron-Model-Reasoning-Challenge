# v20_corrective_corpus_v208_v206_ciphercrypt18

- created_at: 2026-04-30T19:46:19.790980+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Bit Manipulation`. This branch keeps the v206 post-seventeenth-crypt frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v206 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v208_v206_ciphercrypt18_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v206 stack that already replayed the latest cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the seventeenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v208_v206_ciphercrypt18_bundle.jsonl
- base_examples: 7830
- overlay_examples: 62534
- total_examples: 70364
- total_steps: 2200
- total_tokens: 45644847
- max_seq_len: 7971
