# v20_corrective_corpus_v122_v120_guessbit3

- created_at: 2026-04-30T14:24:48.099008+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, `Cipher`, and `Equation Numeric (Guess)`. This branch keeps the v120 third-BIT-refresh frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v120 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v122_v120_guessbit3_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v120 stack that already refreshed third-pass exact-safe BIT pressure.
- Add another guess-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Guess)` slice after the third BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v122_v120_guessbit3_bundle.jsonl
- base_examples: 7830
- overlay_examples: 26240
- total_examples: 34070
- total_steps: 1065
- total_tokens: 35260799
- max_seq_len: 7971
