# v20_corrective_corpus_v102_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_trainingdeduce_numericcipherboost_bitboost_deducefocusboost_guessboost

- created_at: 2026-04-30T13:00:05.023261+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v100 deduce-boost frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by saturating both crypt deduce and guess while preserving the v100 mixed recovery stack.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v102_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_trainingdeduce_numericcipherboost_bitboost_deducefocusboost_guessboost_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v100 mixed frontier that already re-boosted numeric, cipher, BIT, and focused deduce.
- Add another guess-only glyph_len5 replay so the branch saturates both crypt directions without surrendering the restored non-crypt pressure.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v102_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_trainingdeduce_numericcipherboost_bitboost_deducefocusboost_guessboost_bundle.jsonl
- base_examples: 7830
- overlay_examples: 18249
- total_examples: 26079
- total_steps: 816
- total_tokens: 33002826
- max_seq_len: 7971
