# v20_corrective_corpus_v127_v125_deducebit4

- created_at: 2026-04-30T14:45:28.358713+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, `Equation Numeric (Guess)`, and `Cipher`. This branch keeps the v125 fourth-BIT-refresh frontier and adds one more focused cryptarithm-deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v125 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v127_v125_deducebit4_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v125 stack that already refreshed fourth-pass exact-safe BIT pressure.
- Add another focused deduce-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the fourth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v127_v125_deducebit4_bundle.jsonl
- base_examples: 7830
- overlay_examples: 29849
- total_examples: 37679
- total_steps: 1178
- total_tokens: 36129168
- max_seq_len: 7971
