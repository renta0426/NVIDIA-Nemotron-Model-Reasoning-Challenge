# v20_corrective_corpus_v177_v175_numericcrypt12

- created_at: 2026-04-30T17:52:31.890531+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v175 post-twelfth-BIT deduce frontier and adds one more numeric operator and quote replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v175 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v177_v175_numericcrypt12_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v175 stack that already replayed the twelfth focused cryptarithm deduce pass.
- Add another numeric operator and quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the twelfth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v177_v175_numericcrypt12_bundle.jsonl
- base_examples: 7830
- overlay_examples: 52291
- total_examples: 60121
- total_steps: 1880
- total_tokens: 42237840
- max_seq_len: 7971
