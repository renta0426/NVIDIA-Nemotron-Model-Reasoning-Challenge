# v20_corrective_corpus_v101_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_deducefocus_numericcipherboost_bitboost_guessboost_deducefocusboost

- created_at: 2026-04-30T12:59:46.627262+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v99 guess-boost frontier and adds one more focused cryptarithm-deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by saturating both crypt guess and focused deduce while preserving the v99 mixed recovery stack.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v101_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_deducefocus_numericcipherboost_bitboost_guessboost_deducefocusboost_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v99 mixed frontier that already re-boosted numeric, cipher, BIT, and crypt guess.
- Add another focused deduce-only glyph_len5 replay so the branch saturates both crypt directions without surrendering the restored non-crypt pressure.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v101_bit_binary_manual_exact_numeric_cipher_guess_deduce_bitexact_focus_operator_quote_reverse_unknown123_hardcipher_cryptguessheavy_deducefocus_numericcipherboost_bitboost_guessboost_deducefocusboost_bundle.jsonl
- base_examples: 7830
- overlay_examples: 18517
- total_examples: 26347
- total_steps: 824
- total_tokens: 33046658
- max_seq_len: 7971
