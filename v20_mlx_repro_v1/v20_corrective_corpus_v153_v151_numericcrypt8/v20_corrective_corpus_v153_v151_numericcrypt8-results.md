# v20_corrective_corpus_v153_v151_numericcrypt8

- created_at: 2026-04-30T16:20:40.283675+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v151 post-eighth-BIT frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v151 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v153_v151_numericcrypt8_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v151 stack that already replayed the eighth crypt deduce pass.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the eighth post-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v153_v151_numericcrypt8_bundle.jsonl
- base_examples: 7830
- overlay_examples: 41203
- total_examples: 49033
- total_steps: 1533
- total_tokens: 39205264
- max_seq_len: 7971
