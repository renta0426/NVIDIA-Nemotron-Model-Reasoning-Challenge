...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_oct_heavy_expanded"
...
DEFAULT_BUNDLE_PATH = TRAINING_SFT_ROOT / f"{VERSION_NAME}_bundle.jsonl"
...
BUCKET_ORDER = (
    ...
    "surface_binary_prompt_local_answer_only",
    "surface_binary_structured_answer_only",
    "surface_numeric_answer_only",
    "surface_cryptarithm_answer_only",
...
DEFAULT_REPEAT_COUNTS = {
    ...
    "surface_binary_prompt_local_answer_only": 3,
    "surface_binary_structured_answer_only": 3,
    "surface_numeric_answer_only": 3,
    "surface_cryptarithm_answer_only": 3,
...
NUMERIC_GUESS_POPULAR_OPERATOR_COUNT = 8
NUMERIC_GUESS_FALLBACK_OPERATOR_COUNT = 2
NUMERIC_GUESS_VERY_POPULAR_OPERATOR_COUNT = 4
NUMERIC_GUESS_POPULAR_BONUS_REPEAT = 0
NUMERIC_GUESS_VERY_POPULAR_BONUS_REPEAT = 0
NUMERIC_GUESS_FALLBACK_BONUS_REPEAT = 0
NUMERIC_GUESS_TAIL_POOL_MAX = 3
NUMERIC_GUESS_POPULAR_UNIQUE_CAP = 5
NUMERIC_GUESS_FALLBACK_UNIQUE_CAP = 2
CRYPTARITHM_SUPPORT_UNIQUE_LIMIT = 48
CRYPTARITHM_DEDUCE_SUPPORT_UNIQUE_LIMIT = 36
CRYPTARITHM_GUESS_SUPPORT_UNIQUE_LIMIT = 12
CRYPTARITHM_ANALYSIS_PRIORITY = {
    "symbol_glyph_grouped_exact_answer_only": 4,
    "symbol_glyph_grouped_small_set_answer_only": 3,
    "symbol_glyph_grouped_single_example_small_set_answer_only": 2,
    "symbol_glyph_training_answer_only": 1,
}
BIT_V4_PARTIAL_MISS_IDS = {
    "000b53cf",
    "00890aff",
    "012fb81b",
    "01e09228",
...
BIT_V4_PARTIAL_MISS_SUPPORT_BONUS_REPEAT = 1
BIT_V4_PARTIAL_HYPOTHESIS_MISS_IDS = {
    "000b53cf",
    "00890aff",
    "012fb81b",
    "01e09228",
...
BIT_V4_PARTIAL_HYPOTHESIS_MISS_EXTRA_REPEAT = 3
BIT_FAMILY_REBALANCE_STRUCTURED_FAMILY_ORDER = (
    "choose(shl,shr,rol)",
...
BIT_FAMILY_REBALANCE_STRUCTURED_TARGET_COUNTS = {
...
BIT_FAMILY_REBALANCE_STRUCTURED_BONUS_REPEAT = 1
BIT_FAMILY_REBALANCE_PROMPTLOCAL_FAMILY = "binary_prompt_local_stage2_unique_exact"
BIT_FAMILY_REBALANCE_PROMPTLOCAL_BONUS_REPEAT = 1
CRYPT_V4_PARTIAL_MISS_IDS = {
    "00457d26",
    "00c032a8",
    "012cab1f",
    "017a871e",
...
CRYPT_V4_PARTIAL_MISS_SUPPORT_BONUS_REPEAT = 1
CRYPT_V4_PARTIAL_DEDUCE_MISS_IDS = {
    "00457d26",
    "00c032a8",
    "012cab1f",
    "017a871e",
...
CRYPT_V4_PARTIAL_DEDUCE_MISS_EXTRA_REPEAT = 2
CRYPT_V4_PARTIAL_RULE_UNKNOWN_MISS_IDS = {
    "00457d26",
    "00c032a8",
    "012cab1f",
    "01b2aa67",
...
CRYPT_V4_PARTIAL_RULE_UNKNOWN_MISS_EXTRA_REPEAT = 2
FRONTIER_RAW_BIT_CURRENT_MISS_IDS = {"0ec17d2e"}
FRONTIER_RAW_NUMERIC_CURRENT_MISS_IDS = {"00d8b3db"}
FRONTIER_RAW_CURRENT_MISS_IDS = FRONTIER_RAW_BIT_CURRENT_MISS_IDS | FRONTIER_RAW_NUMERIC_CURRENT_MISS_IDS
FRONTIER_RAW_SUPPORT_STATUS_PRIORITY = {
    "rule_unknown": 3,
    "hypothesis_formed": 2,
    "rule_found": 1,
}
FRONTIER_RAW_SUPPORT_BUCKET_BONUS = {
    "surface_binary_structured_answer_only": 5,
    "surface_numeric_answer_only": 4,
}
FRONTIER_RAW_SUPPORT_BONUS_REPEAT = 1
FRONTIER_RAW_CURRENT_MISS_EXTRA_REPEAT = 2
for bucket_name, frontier_bonus in FRONTIER_RAW_SUPPORT_BUCKET_BONUS.items():
    DEFAULT_BUCKET_LIMITS[bucket_name] += frontier_bonus
EQUATION_NUMERIC_GUESS_CURRENT_MISS_IDS = {
    "053f4545",
    "065f9dea",
    "078df00e",
    "07aef27f",
...
EQUATION_NUMERIC_GUESS_CURRENT_MISS_EXTRA_REPEAT = 2
CRYPT_GUESS_CURRENT_MISS_IDS = {
    "01ef1e3e",
    "02902eb3",
    "02e871e4",
    "055a8b01",
...
CRYPT_GUESS_CURRENT_MISS_EXTRA_REPEAT = 2
UNIT_CURRENT_MISS_IDS = {
    "02356cb8",
    "023739fe",
    "0bbde542",
    "0bc7de44",
...
UNIT_CURRENT_MISS_EXTRA_REPEAT = 2
GRAVITY_CURRENT_MISS_IDS = {
    "0409e7d8",
    "06b3ee9d",
    "0b6ca613",
    "0dcdd12b",
}
GRAVITY_CURRENT_MISS_EXTRA_REPEAT = 2
CRYPT_DEDUCE_HYPOTHESIS_CURRENT_MISS_IDS = {
    "017a871e",
    "022c4d73",
    "02c15453",
    "03a3437f",
}
CRYPT_DEDUCE_HYPOTHESIS_CURRENT_MISS_EXTRA_REPEAT = 2
BIT_TAIL_CURRENT_MISS_IDS = {
    "02a66bcb",
    "053f87d3",
    "0b56b953",
    "06b5da9f",
...
BIT_TAIL_CURRENT_MISS_EXTRA_REPEAT = 2
EQUATION_DEDUCE_TAIL_CURRENT_MISS_IDS = {
    "00d8b3db",
    "0bcffccd",
    "0c8a8a16",
}
EQUATION_DEDUCE_TAIL_CURRENT_MISS_EXTRA_REPEAT = 2
CIPHER_CURRENT_MISS_IDS = {
    "0d6d428a",
}
CIPHER_CURRENT_MISS_EXTRA_REPEAT = 2
NUMERIC_V4_PARTIAL_MISS_SUPPORT_IDS = {
    "0bcffccd",
    "0c8a8a16",
    "053f4545",
    "065f9dea",
...
UNIT_V4_PARTIAL_MISS_IDS = {"02356cb8", "023739fe", "0bbde542", "0bc7de44", "0be4c157"}
GRAVITY_V4_PARTIAL_MISS_IDS = {"0409e7d8", "06b3ee9d", "0b6ca613", "0dcdd12b"}
CIPHER_V4_PARTIAL_MISS_IDS = {"0d6d428a"}
MEASURED_SURFACE_MISS_IDS = (
    NUMERIC_V4_PARTIAL_MISS_SUPPORT_IDS
    | UNIT_V4_PARTIAL_MISS_IDS
    | GRAVITY_V4_PARTIAL_MISS_IDS
    | CIPHER_V4_PARTIAL_MISS_IDS
)
MEASURED_SURFACE_MISS_BUCKETS = {
    "surface_numeric_answer_only",
    "surface_unit_tail",
    "easy_gravity_fragile",
    "surface_cipher_boxed",
}
MEASURED_SURFACE_MISS_BONUS_REPEAT = 1
...
def build_surface_completion(candidate: Candidate) -> str:
    ...
    elif bucket == "surface_binary_prompt_local_answer_only":
        lines = [
            "Use the prompt-local binary pattern implied by the examples.",
            "Keep every bit and leading zero exact.",
            "Return only the final byte in \\boxed{...}.",
        ]
    elif bucket == "surface_binary_structured_answer_only":
        lines = [
            "Use the structured byte rule implied by the examples.",
            "Keep every bit and leading zero exact.",
            "Return only the final byte in \\boxed{...}.",
        ]
    ...
    elif bucket == "surface_cryptarithm_answer_only":
        lines = [
            "Use the glyph mapping implied by the examples.",
            "Keep every symbol, grouping, and ordering choice exact.",
            "Return only the final answer in \\boxed{...}.",
        ]
...
def build_surface_short_closure_completion(candidate: Candidate) -> str:
    ...
    if bucket == "surface_numeral_boxed":
        ...
        lines = [
            "Use the prompt-local binary pattern and keep exact 8-bit closure.",
            "Return only the final byte in \\boxed{...}.",
        ]
    elif bucket == "surface_binary_structured_answer_only":
        lines = [
            "Use the structured byte pattern and keep exact 8-bit closure.",
            "Return only the final byte in \\boxed{...}.",
        ]
    elif bucket == "surface_numeric_answer_only":
        lines = [
        ...
        lines = [
            "Use the glyph mapping and keep the symbol surface exact.",
            "Return only the final answer in \\boxed{...}.",
        ]
    elif bucket == "easy_gravity_fragile":
        lines = [
...
def build_supervision_variants(candidate: Candidate, base_variant_count: int) -> list[dict[str, str]]:
    if candidate.bucket.startswith("binary_"):
        family = binary_family_key(candidate.row)
        ...
        if (
            candidate.bucket == "binary_structured_exact_core"
            and family in BIT_FAMILY_REBALANCE_STRUCTURED_TARGET_COUNTS
        ):
            target_count += BIT_FAMILY_REBALANCE_STRUCTURED_BONUS_REPEAT
        if candidate.bucket == "binary_prompt_local_exact" and family == BIT_FAMILY_REBALANCE_PROMPTLOCAL_FAMILY:
            target_count += BIT_FAMILY_REBALANCE_PROMPTLOCAL_BONUS_REPEAT
        rows = [
            {
            ...
            for style in variant_styles[: min(target_count, len(variant_styles))]
        ]
        bonus_variant_count = max(0, target_count - len(rows))
        if bonus_variant_count:
            ...
            for index in range(bonus_variant_count):
                ...
                rows.append(boosted)
        return rows
    if candidate.row["id"] in BIT_V4_PARTIAL_MISS_IDS and candidate.bucket.startswith("surface_binary_"):
        base_variant_count += BIT_V4_PARTIAL_MISS_SUPPORT_BONUS_REPEAT
    if candidate.row["id"] in BIT_V4_PARTIAL_HYPOTHESIS_MISS_IDS and candidate.bucket.startswith("surface_binary_"):
        base_variant_count += BIT_V4_PARTIAL_HYPOTHESIS_MISS_EXTRA_REPEAT
    if candidate.row["id"] in CRYPT_V4_PARTIAL_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_V4_PARTIAL_MISS_SUPPORT_BONUS_REPEAT
    if candidate.row["id"] in CRYPT_V4_PARTIAL_DEDUCE_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_V4_PARTIAL_DEDUCE_MISS_EXTRA_REPEAT
    if candidate.row["id"] in CRYPT_V4_PARTIAL_RULE_UNKNOWN_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_V4_PARTIAL_RULE_UNKNOWN_MISS_EXTRA_REPEAT
    if candidate.row["id"] in MEASURED_SURFACE_MISS_IDS and candidate.bucket in MEASURED_SURFACE_MISS_BUCKETS:
        base_variant_count += MEASURED_SURFACE_MISS_BONUS_REPEAT
    if "frontier_raw_support" in candidate.source_tags:
        base_variant_count += FRONTIER_RAW_SUPPORT_BONUS_REPEAT
    if candidate.row["id"] in FRONTIER_RAW_CURRENT_MISS_IDS and "frontier_raw_support" in candidate.source_tags:
        base_variant_count += FRONTIER_RAW_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in EQUATION_NUMERIC_GUESS_CURRENT_MISS_IDS and candidate.bucket == "surface_numeric_answer_only":
        base_variant_count += EQUATION_NUMERIC_GUESS_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in CRYPT_GUESS_CURRENT_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_GUESS_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in UNIT_CURRENT_MISS_IDS and candidate.bucket == "surface_unit_tail":
        base_variant_count += UNIT_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in GRAVITY_CURRENT_MISS_IDS and candidate.bucket == "easy_gravity_fragile":
        base_variant_count += GRAVITY_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in CRYPT_DEDUCE_HYPOTHESIS_CURRENT_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_DEDUCE_HYPOTHESIS_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in BIT_TAIL_CURRENT_MISS_IDS and candidate.bucket.startswith("surface_binary_"):
        base_variant_count += BIT_TAIL_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in EQUATION_DEDUCE_TAIL_CURRENT_MISS_IDS and candidate.bucket == "surface_numeric_answer_only":
        base_variant_count += EQUATION_DEDUCE_TAIL_CURRENT_MISS_EXTRA_REPEAT
    if candidate.row["id"] in CIPHER_CURRENT_MISS_IDS and candidate.bucket == "surface_cipher_boxed":
        base_variant_count += CIPHER_CURRENT_MISS_EXTRA_REPEAT
...
def validate_canonical_v6(
    *,
    ...
    surface_unexpected_categories = sorted(
        {
            f"{row['bucket']}::{row['category']}"
            for row in surface_selected
            if not (
                row["category"] in {"numeral", "cipher", "unit_conversion", "gravity", "equation_numeric_deduce", "equation_numeric_guess"}
                or (
                    row["bucket"] == "surface_binary_prompt_local_answer_only"
                    and row["category"] == "bit_manipulation"
                )
                or (
                    row["bucket"] == "surface_binary_structured_answer_only"
                    and row["category"] == "bit_manipulation"
                )
                or (
                    row["bucket"] == "surface_cryptarithm_answer_only"
                    and row["category"] in {"cryptarithm_deduce", "cryptarithm_guess"}
                )
            )
        }
    )
...
def load_problem_statuses() -> dict[str, str]:
...
def make_candidate(
    *,
    ...
    merged.setdefault("numeric_guess_operator_popularity_rank", "")
    return Candidate(
        row=merged,
        bucket=bucket,
...
def build_budgeted_candidates(bucket_limits: dict[str, int]) -> tuple[list[Candidate], dict[str, Any]]:
    ...
    problem_statuses = load_problem_statuses()
    base_index_map = load_base_snapshot_index_map()
    measured = load_measured_signals()
    teacher_correctness = load_teacher_correctness()
    train_recommended_rows = list(load_csv_rows(TRAIN_RECOMMENDED_PATH))
    train_recommended_by_id = {row["id"]: row for row in train_recommended_rows}

    candidates: list[Candidate] = []
    missing_reasoning_ids: list[str] = []
    teacher_incorrect_filtered: dict[str, list[str]] = defaultdict(list)
    frontier_raw_support_candidates: Counter[str] = Counter()
    ...
    for bucket, category_name, predicate in support_specs:
        ...
        for rank, row_id in enumerate(ids):
            ...
            if row_id in MEASURED_MANDATORY_IDS.get(bucket, set()):
                source_tags.add("measured_regression")
            if (
                (bucket == "surface_cipher_boxed" and row_id in CIPHER_V4_PARTIAL_MISS_IDS)
                or (bucket == "surface_unit_tail" and row_id in UNIT_V4_PARTIAL_MISS_IDS)
                or (bucket == "easy_gravity_fragile" and row_id in GRAVITY_V4_PARTIAL_MISS_IDS)
            ):
                source_tags.add("v4_live_partial_surface_miss_support")
            priority_key = (
    ...
    direct_surface_anchor_specs = [
        ("surface_cipher_boxed", MEASURED_MANDATORY_IDS["surface_cipher_boxed"]),
        ("surface_unit_tail", MEASURED_MANDATORY_IDS["surface_unit_tail"]),
        ("easy_gravity_fragile", MEASURED_MANDATORY_IDS["easy_gravity_fragile"]),
    ]
    for bucket, row_ids in direct_surface_anchor_specs:
        for row_id in sorted(row_ids):
            candidate = make_candidate(
                ...
                train_prompts=train_prompts,
                categories=categories,
                source_tags={bucket, "mandatory_anchor", "train_prompts_direct"},
                proxy_failed=False,
                validation_failed=False,
                priority_key=(-1, -999.0, 0, 0, row_id),
            )
            if candidate is not None:
                source_row = train_recommended_by_id.get(row_id)
                if source_row is not None:
                    copy_source_metadata(candidate.row, source_row)
                candidates.append(candidate)

    frontier_direct_specs = [
        ("surface_binary_structured_answer_only", "bit_manipulation", FRONTIER_RAW_BIT_CURRENT_MISS_IDS),
        ("surface_numeric_answer_only", "equation_numeric_deduce", FRONTIER_RAW_NUMERIC_CURRENT_MISS_IDS),
    ]
    for bucket, category_name, mandatory_ids in frontier_direct_specs:
        for row_id, row in train_prompts.items():
            if categories.get(row_id) != category_name:
                continue
            if row_id in train_recommended_by_id:
                continue
            if (REASONING_DIR / f"{row_id}.txt").exists() is False:
                continue
            current_proxy_failed = row_id in measured["current_proxy_fail_ids"]
            current_validation_failed = row_id in measured["current_validation_fail_ids"]
            problem_status = problem_statuses.get(row_id, "")
            source_tags = {bucket, "frontier_raw_support", "train_prompts_direct"}
            if problem_status:
                source_tags.add(f"problem_status_{problem_status}")
            if row_id in mandatory_ids:
                source_tags.add("current_frontier_miss_support")
            if current_proxy_failed:
                source_tags.add("current_proxy_fail")
            if current_validation_failed:
                source_tags.add("current_validation_fail")
            priority_key = (
                -(1 if row_id in mandatory_ids else 0),
                -(1 if current_validation_failed else 0),
                -(1 if current_proxy_failed else 0),
                -FRONTIER_RAW_SUPPORT_STATUS_PRIORITY.get(problem_status, 0),
                -len(str(row.get("prompt", ""))),
                row_id,
            )
            candidate = make_candidate(
                row_id=row_id,
            ...
            if candidate is not None:
                candidate.row["problem_status"] = problem_status
                candidates.append(candidate)
                frontier_raw_support_candidates[bucket] += 1

    direct_surface_miss_specs = [
        ("surface_cipher_boxed", CIPHER_V4_PARTIAL_MISS_IDS),
        ("surface_unit_tail", UNIT_V4_PARTIAL_MISS_IDS),
        ("easy_gravity_fragile", GRAVITY_V4_PARTIAL_MISS_IDS),
    ]
    for bucket, row_ids in direct_surface_miss_specs:
        for row_id in sorted(row_ids):
            current_proxy_failed = row_id in measured["current_proxy_fail_ids"]
            current_validation_failed = row_id in measured["current_validation_fail_ids"]
            source_tags = {bucket, "v4_live_partial_surface_miss_support", "train_prompts_direct"}
            if current_proxy_failed:
                source_tags.add("current_proxy_fail")
            if current_validation_failed:
                source_tags.add("current_validation_fail")
    ...
    for row in train_recommended_rows:
        ...
        source_tags = {
            ...
            "surface_binary_prompt_local_answer_only",
            "bit_prompt_local_answer_only_support",
        }
        if analysis_notes:
            source_tags.add(analysis_notes)
        if current_proxy_failed:
            source_tags.add("current_proxy_fail")
        if current_validation_failed:
            source_tags.add("current_validation_fail")
        priority_key = (
            -(1 if analysis_notes == "bit_prompt_local_current_consensus_answer_only" else 0),
            -(1 if current_proxy_failed else 0),
            -(1 if current_validation_failed else 0),
            -tier_priority,
            -hard_score,
        ...
        candidate = make_candidate(
            row_id=row_id,
            bucket="surface_binary_prompt_local_answer_only",
            train_prompts=train_prompts,
            categories=categories,
            source_tags=source_tags,
            proxy_failed=current_proxy_failed,
        ...
        if candidate is not None:
            copy_source_metadata(candidate.row, row)
            candidates.append(candidate)
            binary_support_candidates += 1

    structured_support_candidates = 0
    for row_id in sorted(BIT_V4_PARTIAL_MISS_IDS):
        row = train_recommended_by_id.get(row_id)
        if row is None:
            continue
        category = categories.get(row_id, "")
        if category != "bit_manipulation":
        ...
        if template_subtype == "bit_prompt_local_exact_formula":
            bucket = "surface_binary_prompt_local_answer_only"
            support_tag = "bit_prompt_local_answer_only_support"
        else:
            bucket = "surface_binary_structured_answer_only"
            support_tag = "bit_structured_answer_only_support"
        current_proxy_failed = row_id in measured["current_proxy_fail_ids"]
        current_validation_failed = row_id in measured["current_validation_fail_ids"]
        tier_priority = SELECTION_TIER_PRIORITY.get(str(row.get("selection_tier", "")).strip(), 0)
        hard_score = parse_float(row.get("hard_score", 0.0), 0.0)
        ...
        source_tags = {
            ...
            bucket,
            support_tag,
            "v4_live_partial_bit_miss_support",
        }
        analysis_notes = str(row.get("analysis_notes", "")).strip()
        if analysis_notes:
            source_tags.add(analysis_notes)
        ...
        if candidate is not None:
            copy_source_metadata(candidate.row, row)
            candidates.append(candidate)
            if bucket == "surface_binary_prompt_local_answer_only":
                binary_support_candidates += 1
            else:
                structured_support_candidates += 1

    for row in train_recommended_rows:
        row_id = row["id"]
        if str(row.get("template_subtype", "")).strip() != "bit_structured_byte_formula":
            continue
        if str(row.get("selection_tier", "")).strip() != "answer_only_keep":
            continue
        analysis_notes = str(row.get("analysis_notes", "")).strip()
        if analysis_notes != "bit_prompt_local_current_consensus_answer_only":
            continue
        category = categories.get(row_id, "")
        if category != "bit_manipulation":
            continue
        ...
        source_tags = {
            "train_recommended_learning_target_v1",
            "surface_binary_structured_answer_only",
            "bit_structured_answer_only_support",
            analysis_notes,
        }
        if current_proxy_failed:
            source_tags.add("current_proxy_fail")
    ...
    popular_and_fallback_operator_order = [
        operator
        for operator, _count in sorted(
            numeric_guess_operator_counts.items(),
            key=lambda item: (-item[1], item[0]),
        )[: NUMERIC_GUESS_POPULAR_OPERATOR_COUNT + NUMERIC_GUESS_FALLBACK_OPERATOR_COUNT]
    ]
    popular_operator_rank = {operator: index + 1 for index, operator in enumerate(popular_and_fallback_operator_order)}
    ...
    for row in train_recommended_rows:
        ...
        if row_id in NUMERIC_V4_PARTIAL_MISS_SUPPORT_IDS:
            source_tags.add("v4_live_partial_surface_miss_support")
        ...
        if candidate is not None:
            ...
            if category == "equation_numeric_guess":
                ...
                candidate.row["numeric_guess_operator_popularity_rank"] = str(popular_operator_rank.get(operator, 0))
            candidates.append(candidate)
            numeric_support_candidates += 1

    cryptarithm_support_candidates = 0
    for row in train_recommended_rows:
        row_id = row["id"]
        ...
        if str(row.get("selection_tier", "")).strip() != "answer_only_keep":
            continue
        category = categories.get(row_id, "")
        if category not in {"cryptarithm_deduce", "cryptarithm_guess"}:
            continue
        current_proxy_failed = row_id in measured["current_proxy_fail_ids"]
        current_validation_failed = row_id in measured["current_validation_fail_ids"]
        analysis_notes = str(row.get("analysis_notes", "")).strip()
        ...
        source_tags = {
            "train_recommended_learning_target_v1",
            "surface_cryptarithm_answer_only",
            "cryptarithm_answer_only_support",
            category,
        }
        if row_id in CRYPT_V4_PARTIAL_MISS_IDS:
            source_tags.add("v4_live_partial_crypt_miss_support")
        if analysis_notes:
            source_tags.add(analysis_notes)
        if current_proxy_failed:
            source_tags.add("current_proxy_fail")
        if current_validation_failed:
            source_tags.add("current_validation_fail")
        priority_key = (
            -(1 if category == "cryptarithm_deduce" else 0),
            -CRYPTARITHM_ANALYSIS_PRIORITY.get(analysis_notes, 0),
            -(1 if current_proxy_failed else 0),
            -(1 if current_validation_failed else 0),
            -tier_priority,
            -hard_score,
        ...
        candidate = make_candidate(
            row_id=row_id,
            bucket="surface_cryptarithm_answer_only",
            train_prompts=train_prompts,
            categories=categories,
            source_tags=source_tags,
            proxy_failed=current_proxy_failed,
        ...
        if candidate is not None:
            copy_source_metadata(candidate.row, row)
            candidates.append(candidate)
            cryptarithm_support_candidates += 1
    ...
    diagnostics = {
        ...
        "binary_prompt_local_answer_only_support_candidates": binary_support_candidates,
        "binary_structured_answer_only_support_candidates": structured_support_candidates,
        "numeric_answer_only_support_candidates": numeric_support_candidates,
        "cryptarithm_answer_only_support_candidates": cryptarithm_support_candidates,
        "frontier_raw_support_bucket_bonus": dict(FRONTIER_RAW_SUPPORT_BUCKET_BONUS),
        "frontier_raw_current_miss_ids": sorted(FRONTIER_RAW_CURRENT_MISS_IDS),
        "equation_numeric_guess_current_miss_ids": sorted(EQUATION_NUMERIC_GUESS_CURRENT_MISS_IDS),
        "crypt_guess_current_miss_ids": sorted(CRYPT_GUESS_CURRENT_MISS_IDS),
        "unit_current_miss_ids": sorted(UNIT_CURRENT_MISS_IDS),
        "gravity_current_miss_ids": sorted(GRAVITY_CURRENT_MISS_IDS),
        "crypt_deduce_hypothesis_current_miss_ids": sorted(CRYPT_DEDUCE_HYPOTHESIS_CURRENT_MISS_IDS),
        "bit_tail_current_miss_ids": sorted(BIT_TAIL_CURRENT_MISS_IDS),
        "equation_deduce_tail_current_miss_ids": sorted(EQUATION_DEDUCE_TAIL_CURRENT_MISS_IDS),
        "cipher_current_miss_ids": sorted(CIPHER_CURRENT_MISS_IDS),
        "frontier_raw_support_candidate_counts": dict(sorted(frontier_raw_support_candidates.items())),
        "v4_live_partial_crypt_miss_support_ids": sorted(CRYPT_V4_PARTIAL_MISS_IDS),
        "v4_live_partial_crypt_deduce_miss_support_ids": sorted(CRYPT_V4_PARTIAL_DEDUCE_MISS_IDS),
        "v4_live_partial_crypt_rule_unknown_miss_support_ids": sorted(CRYPT_V4_PARTIAL_RULE_UNKNOWN_MISS_IDS),
        "v4_live_partial_bit_hypothesis_miss_support_ids": sorted(BIT_V4_PARTIAL_HYPOTHESIS_MISS_IDS),
        "v4_live_partial_bit_miss_support_ids": sorted(BIT_V4_PARTIAL_MISS_IDS),
        "bit_family_rebalance_structured_target_counts": dict(BIT_FAMILY_REBALANCE_STRUCTURED_TARGET_COUNTS),
        "bit_family_rebalance_promptlocal_family": BIT_FAMILY_REBALANCE_PROMPTLOCAL_FAMILY,
        "v4_live_partial_numeric_miss_support_ids": sorted(NUMERIC_V4_PARTIAL_MISS_SUPPORT_IDS),
        "v4_live_partial_unit_miss_ids": sorted(UNIT_V4_PARTIAL_MISS_IDS),
        "v4_live_partial_gravity_miss_ids": sorted(GRAVITY_V4_PARTIAL_MISS_IDS),
        "v4_live_partial_cipher_miss_ids": sorted(CIPHER_V4_PARTIAL_MISS_IDS),
        "numeric_guess_operator_candidates": sorted(numeric_guess_operator_candidates),
        "numeric_guess_operator_counts": dict(sorted(numeric_guess_operator_counts.items())),
        "numeric_guess_popular_and_fallback_operator_order": popular_and_fallback_operator_order,
    }
...
def select_candidates(candidates: list[Candidate], bucket_limits: dict[str, int]) -> list[Candidate]:
    ...
    for family in BIT_FAMILY_REBALANCE_STRUCTURED_FAMILY_ORDER:
        target = BIT_FAMILY_REBALANCE_STRUCTURED_TARGET_COUNTS[family]
        for candidate in family_candidates.get(family, []):
            if counts["binary_structured_exact_core"] >= bucket_limits["binary_structured_exact_core"]:
                break
            if structured_family_counts[family] >= target:
                break
            add_candidate(candidate)
    ...
    popular_and_fallback_operator_order = [
        ...
        for operator in sorted(
            numeric_guess_by_operator,
            key=lambda operator: (
                -parse_int(numeric_guess_by_operator[operator][0].row.get("numeric_guess_operator_pool_count", 0), 0),
                operator,
            ),
        )[: NUMERIC_GUESS_POPULAR_OPERATOR_COUNT + NUMERIC_GUESS_FALLBACK_OPERATOR_COUNT]
    ]
    popular_operator_order = popular_and_fallback_operator_order[:NUMERIC_GUESS_POPULAR_OPERATOR_COUNT]
    fallback_operator_order = popular_and_fallback_operator_order[
        NUMERIC_GUESS_POPULAR_OPERATOR_COUNT : NUMERIC_GUESS_POPULAR_OPERATOR_COUNT + NUMERIC_GUESS_FALLBACK_OPERATOR_COUNT
    ]
    popular_operator_set = set(popular_operator_order)
    tail_operators = [
        operator for operator in operator_order if len(numeric_guess_by_operator[operator]) <= NUMERIC_GUESS_TAIL_POOL_MAX
    ]
    for candidate in numeric_candidates:
        if candidate.row["id"] not in NUMERIC_V4_PARTIAL_MISS_SUPPORT_IDS:
            continue
        if counts[numeric_bucket] >= bucket_limits[numeric_bucket]:
            break
        add_candidate(candidate)
    frontier_numeric_selected = 0
    for candidate in numeric_candidates:
        if "frontier_raw_support" not in candidate.source_tags:
            continue
        if candidate.row["category"] != "equation_numeric_deduce":
            continue
        if frontier_numeric_selected >= FRONTIER_RAW_SUPPORT_BUCKET_BONUS[numeric_bucket]:
            break
        before = counts[numeric_bucket]
        add_candidate(candidate)
        if counts[numeric_bucket] != before:
            frontier_numeric_selected += 1
    for operator in tail_operators:
        for candidate in numeric_guess_by_operator[operator]:
            if counts[numeric_bucket] >= bucket_limits[numeric_bucket]:
                break
            add_candidate(candidate)
    ...
    cryptarithm_bucket = "surface_cryptarithm_answer_only"
    cryptarithm_candidates = [candidate for candidate in candidates if candidate.bucket == cryptarithm_bucket]
    cryptarithm_deduce_candidates = [
        candidate for candidate in cryptarithm_candidates if candidate.row["category"] == "cryptarithm_deduce"
    ]
    cryptarithm_guess_candidates = [
        candidate for candidate in cryptarithm_candidates if candidate.row["category"] == "cryptarithm_guess"
    ]
    for candidate in cryptarithm_candidates:
        if candidate.row["id"] not in CRYPT_V4_PARTIAL_MISS_IDS:
            continue
        if counts[cryptarithm_bucket] >= min(bucket_limits[cryptarithm_bucket], CRYPTARITHM_SUPPORT_UNIQUE_LIMIT):
            break
        add_candidate(candidate)
    for candidate in cryptarithm_deduce_candidates:
        if counts[cryptarithm_bucket] >= min(bucket_limits[cryptarithm_bucket], CRYPTARITHM_DEDUCE_SUPPORT_UNIQUE_LIMIT):
            break
        add_candidate(candidate)
    for candidate in cryptarithm_guess_candidates:
        if counts[cryptarithm_bucket] >= min(
            bucket_limits[cryptarithm_bucket],
            CRYPTARITHM_DEDUCE_SUPPORT_UNIQUE_LIMIT + CRYPTARITHM_GUESS_SUPPORT_UNIQUE_LIMIT,
        ):
            break
        add_candidate(candidate)
    for candidate in cryptarithm_candidates:
    ...
    for candidate in candidates:
        if candidate.row["id"] not in BIT_V4_PARTIAL_MISS_IDS:
            continue
        if candidate.bucket not in {
            "surface_binary_prompt_local_answer_only",
            "surface_binary_structured_answer_only",
        ...
        if counts[candidate.bucket] >= bucket_limits[candidate.bucket]:
            continue
        add_candidate(candidate)
    frontier_binary_selected = 0
    for candidate in candidates:
        if candidate.bucket != "surface_binary_structured_answer_only":
            continue
        if "frontier_raw_support" not in candidate.source_tags:
            continue
        if frontier_binary_selected >= FRONTIER_RAW_SUPPORT_BUCKET_BONUS["surface_binary_structured_answer_only"]:
            break
        before = counts[candidate.bucket]
        add_candidate(candidate)
        if counts[candidate.bucket] != before:
            frontier_binary_selected += 1

    surface_mandatory_ids = (
        MEASURED_MANDATORY_IDS["surface_cipher_boxed"]
        | MEASURED_MANDATORY_IDS["surface_unit_tail"]
        | MEASURED_MANDATORY_IDS["easy_gravity_fragile"]
    )
    for candidate in candidates:
        if candidate.row["id"] not in surface_mandatory_ids:
            continue
        if candidate.bucket not in {"surface_unit_tail", "easy_gravity_fragile", "surface_cipher_boxed"}:
            continue
        if counts[candidate.bucket] >= bucket_limits[candidate.bucket]:
            continue
        add_candidate(candidate)

    residual_surface_limits = {
        "surface_cipher_boxed": max(0, bucket_limits["surface_cipher_boxed"] - len(MEASURED_MANDATORY_IDS["surface_cipher_boxed"])),
        "surface_unit_tail": max(0, bucket_limits["surface_unit_tail"] - len(MEASURED_MANDATORY_IDS["surface_unit_tail"])),
        "easy_gravity_fragile": max(0, bucket_limits["easy_gravity_fragile"] - len(MEASURED_MANDATORY_IDS["easy_gravity_fragile"])),
    }
    residual_surface_counts: Counter[str] = Counter()
    for candidate in candidates:
        if candidate.row["id"] not in (UNIT_V4_PARTIAL_MISS_IDS | GRAVITY_V4_PARTIAL_MISS_IDS | CIPHER_V4_PARTIAL_MISS_IDS):
            continue
        if candidate.bucket not in {"surface_unit_tail", "easy_gravity_fragile", "surface_cipher_boxed"}:
            continue
        if counts[candidate.bucket] >= bucket_limits[candidate.bucket]:
            continue
        if residual_surface_counts[candidate.bucket] >= residual_surface_limits[candidate.bucket]:
            continue
        add_candidate(candidate)
        residual_surface_counts[candidate.bucket] += 1

    for bucket in BUCKET_ORDER:
        if bucket in {"binary_structured_exact_core", numeric_bucket, cryptarithm_bucket}:
            continue
        for candidate in candidates:
            ...
            if counts[bucket] >= bucket_limits[bucket]:
                break
            add_candidate(candidate)
    numeric_operator_selected_counts: Counter[str] = Counter()
    for candidate in selected:
        if candidate.bucket == numeric_bucket and candidate.row["category"] == "equation_numeric_guess":
            numeric_operator_selected_counts[candidate.row.get("symbol_query_operator", "")] += 1
    for operator in fallback_operator_order:
        while counts[numeric_bucket] < bucket_limits[numeric_bucket]:
            if numeric_operator_selected_counts[operator] >= NUMERIC_GUESS_FALLBACK_UNIQUE_CAP:
                break
            added = False
            for candidate in numeric_guess_by_operator.get(operator, []):
                before = counts[numeric_bucket]
                add_candidate(candidate)
                if counts[numeric_bucket] != before:
                    numeric_operator_selected_counts[operator] += 1
                    added = True
                    break
            if not added:
                break
    while counts[numeric_bucket] < bucket_limits[numeric_bucket]:
        added_any = False
        for operator in popular_operator_order:
            if counts[numeric_bucket] >= bucket_limits[numeric_bucket]:
                break
            if numeric_operator_selected_counts[operator] >= NUMERIC_GUESS_POPULAR_UNIQUE_CAP:
                continue
            for candidate in numeric_guess_by_operator.get(operator, []):
                before = counts[numeric_bucket]
                add_candidate(candidate)
    ...
    for candidate in numeric_candidates:
        if counts[numeric_bucket] >= bucket_limits[numeric_bucket]:
            break
        if candidate.row.get("symbol_query_operator", "") not in popular_operator_set:
            continue
        add_candidate(candidate)
    for candidate in numeric_candidates:
        if counts[numeric_bucket] >= bucket_limits[numeric_bucket]:
...
def build_overlay_rows(selected: list[Candidate], repeat_counts: dict[str, int]) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    for candidate in selected:
        ...
        if candidate.bucket == "surface_numeric_answer_only" and candidate.row["category"] == "equation_numeric_guess":
            popularity_rank = parse_int(candidate.row.get("numeric_guess_operator_popularity_rank", 0), 0)
            if 0 < popularity_rank <= NUMERIC_GUESS_VERY_POPULAR_OPERATOR_COUNT:
                base_variant_count += NUMERIC_GUESS_VERY_POPULAR_BONUS_REPEAT
            elif 0 < popularity_rank <= NUMERIC_GUESS_POPULAR_OPERATOR_COUNT:
                base_variant_count += NUMERIC_GUESS_POPULAR_BONUS_REPEAT
            elif 0 < popularity_rank <= NUMERIC_GUESS_POPULAR_OPERATOR_COUNT + NUMERIC_GUESS_FALLBACK_OPERATOR_COUNT:
                base_variant_count += NUMERIC_GUESS_FALLBACK_BONUS_REPEAT
        ...
        base = {
            ...
            "numeric_guess_operator_pool_count": candidate.row.get("numeric_guess_operator_pool_count", ""),
            "numeric_guess_operator_popularity_rank": candidate.row.get("numeric_guess_operator_popularity_rank", ""),
...
def build_training_bundle(
    ...
    manifest = {
        ...
        "note": (
            ...
            "plus a promptlocal-heavy exact-binary overlay with short-closure and token-skill lanes plus a heavier anti-default1 pack, "
            "a plain popular8 numeric support lane, a glyph_len5 cryptarithm answer-only support lane, "
            "and direct answer-only support reserves for the current v4 partial bit, cryptarithm, and residual surface misses."
        ),
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build the v6 promptlocal-short-token-binary-support-hybrid-expanded-numeric-popular8-plain-cryptarithm-support-bit-miss-support-crypt-miss-support-measured-surface-support corrective corpus for the v20 Kaggle reproduction path, "
            "keeping the prompt-local full support base, keeping the expanded structured-byte answer-only support lane, "
            "keeping the numeric popular8 capped fallback-unique answer-only lane without extra numeric boost repeats, "
            "reallocating extra support budget into a glyph_len5 cryptarithm answer-only lane, "
            "and reserving the current v4 partial bit, cryptarithm, and residual surface miss rows directly into the support lanes while retaining short-closure, "
            "token-skill, anti-default1, and minimal boxed-surface stabilizers."
        )
    )
    parser.add_argument("--run-name", default="v6_frontier_oct_heavy_expanded_default")
...
def main() -> None:
    ...
    report_lines = [
        "# v20 corrective corpus v6 promptlocal-short-token-binary-support-hybrid-expanded-numeric-popular8-plain-cryptarithm-support-bit-miss-support-crypt-miss-support-measured-surface-support report",
        "",
        "## Purpose",
        "",
        ...
        "adds a full prompt-local bit answer-only support lane plus an expanded structured-byte answer-only support lane,",
        "keeps the plain numeric popular8 coverage lane,",
        "and adds a glyph_len5 cryptarithm answer-only support lane aligned to the README split/concat weakness,",
        "and reserves the current v4 partial bit, cryptarithm, and residual surface miss rows directly inside the support lanes,",
