# v20_corrective_corpus_v218_v216_guessbit19

- created_at: 2026-04-30T20:37:49.013993+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v216 post-nineteenth-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v216 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v218_v216_guessbit19_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v216 stack that already replayed the nineteenth exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the nineteenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v218_v216_guessbit19_bundle.jsonl
- base_examples: 7830
- overlay_examples: 67440
- total_examples: 75270
- total_steps: 2353
- total_tokens: 47071215
- max_seq_len: 7971
