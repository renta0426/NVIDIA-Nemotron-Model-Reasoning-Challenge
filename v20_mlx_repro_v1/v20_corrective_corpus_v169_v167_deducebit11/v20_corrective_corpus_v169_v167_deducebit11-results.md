# v20_corrective_corpus_v169_v167_deducebit11

- created_at: 2026-04-30T17:18:39.208963+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v167 post-eleventh-BIT frontier and adds one more focused cryptarithm deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v167 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v169_v167_deducebit11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v167 stack that already replayed the eleventh exact-safe BIT pass.
- Add another focused cryptarithm deduce replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the eleventh BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v169_v167_deducebit11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 49253
- total_examples: 57083
- total_steps: 1785
- total_tokens: 41436176
- max_seq_len: 7971
