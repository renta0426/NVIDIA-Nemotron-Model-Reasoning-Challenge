# v20_corrective_corpus_v170_v168_guessbit11

- created_at: 2026-04-30T17:19:11.687671+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v168 post-eleventh-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v168 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v170_v168_guessbit11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v168 stack that already replayed the eleventh exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the eleventh BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v170_v168_guessbit11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 46840
- total_examples: 54670
- total_steps: 1709
- total_tokens: 41166007
- max_seq_len: 7971
