# v20_corrective_corpus_v130_v128_ciphercrypt4

- created_at: 2026-04-30T14:54:52.151048+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Equation Numeric (Guess)`. This branch keeps the v128 post-fourth-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v128 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v130_v128_ciphercrypt4_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v128 stack that already refreshed post-fourth-BIT guess pressure.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the post-fourth-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v130_v128_ciphercrypt4_bundle.jsonl
- base_examples: 7830
- overlay_examples: 29059
- total_examples: 36889
- total_steps: 1154
- total_tokens: 36048884
- max_seq_len: 7971
