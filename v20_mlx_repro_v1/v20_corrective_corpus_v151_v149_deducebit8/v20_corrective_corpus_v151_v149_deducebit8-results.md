# v20_corrective_corpus_v151_v149_deducebit8

- created_at: 2026-04-30T16:13:34.873240+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v149 post-eighth-BIT frontier and adds one more focused cryptarithm deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v149 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v151_v149_deducebit8_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v149 stack that already replayed the eighth exact-safe BIT pass.
- Add another focused cryptarithm deduce replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the eighth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v151_v149_deducebit8_bundle.jsonl
- base_examples: 7830
- overlay_examples: 40937
- total_examples: 48767
- total_steps: 1525
- total_tokens: 39161744
- max_seq_len: 7971
