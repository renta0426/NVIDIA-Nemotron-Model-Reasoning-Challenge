# v20_corrective_corpus_v166_v164_ciphercrypt10

- created_at: 2026-04-30T17:01:17.337174+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v164 post-tenth-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v164 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v166_v164_ciphercrypt10_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v164 stack that already replayed the tenth post-BIT crypt guess pass.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the tenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v166_v164_ciphercrypt10_bundle.jsonl
- base_examples: 7830
- overlay_examples: 44509
- total_examples: 52339
- total_steps: 1636
- total_tokens: 40477790
- max_seq_len: 7971
