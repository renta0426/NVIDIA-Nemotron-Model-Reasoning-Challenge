# v20_corrective_corpus_v176_v174_guessbit12

- created_at: 2026-04-30T17:44:29.209573+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v174 post-twelfth-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v174 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v176_v174_guessbit12_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v174 stack that already replayed the twelfth exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the twelfth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v176_v174_guessbit12_bundle.jsonl
- base_examples: 7830
- overlay_examples: 49415
- total_examples: 57245
- total_steps: 1790
- total_tokens: 41904158
- max_seq_len: 7971
