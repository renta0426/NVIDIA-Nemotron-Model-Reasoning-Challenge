# v20_corrective_corpus_v139_v137_deducebit6

- created_at: 2026-04-30T15:41:09.026917+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, `Equation Numeric (Guess)`, and `Cipher`. This branch keeps the v137 sixth-BIT-refresh frontier and adds one more focused cryptarithm-deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v137 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v139_v137_deducebit6_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v137 stack that already refreshed sixth-pass exact-safe BIT pressure.
- Add another focused deduce-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the sixth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v139_v137_deducebit6_bundle.jsonl
- base_examples: 7830
- overlay_examples: 35393
- total_examples: 43223
- total_steps: 1352
- total_tokens: 37645456
- max_seq_len: 7971
