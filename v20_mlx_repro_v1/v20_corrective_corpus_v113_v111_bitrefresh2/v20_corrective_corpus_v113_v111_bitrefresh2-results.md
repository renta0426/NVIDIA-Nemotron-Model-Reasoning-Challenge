# v20_corrective_corpus_v113_v111_bitrefresh2

- created_at: 2026-04-30T13:47:24.523123+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, and `Cipher`. This branch keeps the v111 post-bit numeric frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v111 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v113_v111_bitrefresh2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v111 stack that already refreshed post-bit numeric pressure.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the post-bit numeric refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v113_v111_bitrefresh2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 23528
- total_examples: 31358
- total_steps: 981
- total_tokens: 34493649
- max_seq_len: 7971
