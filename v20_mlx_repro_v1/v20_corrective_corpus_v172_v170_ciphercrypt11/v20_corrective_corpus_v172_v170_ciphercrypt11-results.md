# v20_corrective_corpus_v172_v170_ciphercrypt11

- created_at: 2026-04-30T17:27:37.091449+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v170 post-eleventh-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v170 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v172_v170_ciphercrypt11_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v170 stack that already replayed the eleventh post-BIT crypt guess pass.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the eleventh crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v172_v170_ciphercrypt11_bundle.jsonl
- base_examples: 7830
- overlay_examples: 47084
- total_examples: 54914
- total_steps: 1717
- total_tokens: 41215941
- max_seq_len: 7971
