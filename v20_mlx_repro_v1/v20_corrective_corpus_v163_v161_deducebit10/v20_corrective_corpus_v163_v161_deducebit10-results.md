# v20_corrective_corpus_v163_v161_deducebit10

- created_at: 2026-04-30T16:55:37.188039+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v161 post-tenth-BIT frontier and adds one more focused cryptarithm deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v161 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v163_v161_deducebit10_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v161 stack that already replayed the tenth exact-safe BIT pass.
- Add another focused cryptarithm deduce replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the tenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v163_v161_deducebit10_bundle.jsonl
- base_examples: 7830
- overlay_examples: 46481
- total_examples: 54311
- total_steps: 1698
- total_tokens: 40678032
- max_seq_len: 7971
