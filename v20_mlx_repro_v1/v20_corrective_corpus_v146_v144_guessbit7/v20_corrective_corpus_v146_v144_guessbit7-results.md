# v20_corrective_corpus_v146_v144_guessbit7

- created_at: 2026-04-30T15:57:44.846650+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v144 post-seventh-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v144 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v146_v144_guessbit7_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v144 stack that already replayed the seventh exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the seventh BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v146_v144_guessbit7_bundle.jsonl
- base_examples: 7830
- overlay_examples: 36540
- total_examples: 44370
- total_steps: 1387
- total_tokens: 38213403
- max_seq_len: 7971
