# v20_corrective_corpus_v116_v114_guessbit2

- created_at: 2026-04-30T13:54:00.281698+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, `Cipher`, and `Equation Numeric (Guess)`. This branch keeps the v114 second-BIT-refresh frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v114 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v116_v114_guessbit2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v114 stack that already refreshed second-pass exact-safe BIT pressure.
- Add another guess-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Guess)` slice after the second BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v116_v114_guessbit2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 23665
- total_examples: 31495
- total_steps: 985
- total_tokens: 34522648
- max_seq_len: 7971
