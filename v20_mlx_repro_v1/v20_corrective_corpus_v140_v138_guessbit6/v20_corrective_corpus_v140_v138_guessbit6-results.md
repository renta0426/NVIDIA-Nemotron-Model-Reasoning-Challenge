# v20_corrective_corpus_v140_v138_guessbit6

- created_at: 2026-04-30T15:41:34.661152+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, `Cipher`, and `Equation Numeric (Guess)`. This branch keeps the v138 sixth-BIT-refresh frontier and adds one more cryptarithm-guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v138 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v140_v138_guessbit6_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v138 stack that already refreshed sixth-pass exact-safe BIT pressure.
- Add another guess-only glyph_len5 replay so the branch revisits the README `Cryptarithm (Guess)` slice after the sixth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v140_v138_guessbit6_bundle.jsonl
- base_examples: 7830
- overlay_examples: 33965
- total_examples: 41795
- total_steps: 1307
- total_tokens: 37475252
- max_seq_len: 7971
