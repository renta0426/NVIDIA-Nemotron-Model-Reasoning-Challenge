# v20_corrective_corpus_v184_v182_ciphercrypt14

- created_at: 2026-04-30T18:17:33.710451+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Bit Manipulation`. This branch keeps the v182 post-thirteenth-crypt frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v182 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v184_v182_ciphercrypt14_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v182 stack that already replayed the thirteenth cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the thirteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v184_v182_ciphercrypt14_bundle.jsonl
- base_examples: 7830
- overlay_examples: 52234
- total_examples: 60064
- total_steps: 1878
- total_tokens: 42692243
- max_seq_len: 7971
