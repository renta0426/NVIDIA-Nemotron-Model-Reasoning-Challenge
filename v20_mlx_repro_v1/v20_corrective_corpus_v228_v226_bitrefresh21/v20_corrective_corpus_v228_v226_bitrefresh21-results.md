# v20_corrective_corpus_v228_v226_bitrefresh21

- created_at: 2026-04-30T21:19:53.864003+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v226 post-twenty-first-cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v226 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v228_v226_bitrefresh21_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v226 stack that already replayed the latest hard-cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v228_v226_bitrefresh21_bundle.jsonl
- base_examples: 7830
- overlay_examples: 71988
- total_examples: 79818
- total_steps: 2495
- total_tokens: 48454693
- max_seq_len: 7971
