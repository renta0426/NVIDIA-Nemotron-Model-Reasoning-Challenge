# v20_corrective_corpus_v188_v186_guessbit14

- created_at: 2026-04-30T18:31:29.970840+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v186 post-fourteenth-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v186 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v188_v186_guessbit14_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v186 stack that already replayed the fourteenth exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the fourteenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v188_v186_guessbit14_bundle.jsonl
- base_examples: 7830
- overlay_examples: 54565
- total_examples: 62395
- total_steps: 1951
- total_tokens: 43380460
- max_seq_len: 7971
