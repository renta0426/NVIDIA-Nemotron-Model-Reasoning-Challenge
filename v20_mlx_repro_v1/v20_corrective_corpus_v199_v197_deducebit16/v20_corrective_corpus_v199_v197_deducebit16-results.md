# v20_corrective_corpus_v199_v197_deducebit16

- created_at: 2026-04-30T19:14:47.692014+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v197 post-sixteenth-BIT frontier and adds one more focused cryptarithm deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v197 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v199_v197_deducebit16_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v197 stack that already replayed the sixteenth exact-safe BIT pass.
- Add another focused cryptarithm deduce replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the sixteenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v199_v197_deducebit16_bundle.jsonl
- base_examples: 7830
- overlay_examples: 63113
- total_examples: 70943
- total_steps: 2218
- total_tokens: 45226896
- max_seq_len: 7971
