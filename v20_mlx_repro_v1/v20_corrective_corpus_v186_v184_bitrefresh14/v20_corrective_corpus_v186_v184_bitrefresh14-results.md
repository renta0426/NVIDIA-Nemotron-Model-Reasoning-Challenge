# v20_corrective_corpus_v186_v184_bitrefresh14

- created_at: 2026-04-30T18:23:34.755798+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v184 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v184 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v186_v184_bitrefresh14_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v184 stack that already replayed the latest numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v186_v184_bitrefresh14_bundle.jsonl
- base_examples: 7830
- overlay_examples: 53963
- total_examples: 61793
- total_steps: 1932
- total_tokens: 43287636
- max_seq_len: 7971
