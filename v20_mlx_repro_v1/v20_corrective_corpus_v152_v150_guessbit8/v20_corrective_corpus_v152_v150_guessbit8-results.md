# v20_corrective_corpus_v152_v150_guessbit8

- created_at: 2026-04-30T16:13:32.500589+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v150 post-eighth-BIT frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v150 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v152_v150_guessbit8_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v150 stack that already replayed the eighth exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the eighth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v152_v150_guessbit8_bundle.jsonl
- base_examples: 7830
- overlay_examples: 39115
- total_examples: 46945
- total_steps: 1468
- total_tokens: 38951554
- max_seq_len: 7971
