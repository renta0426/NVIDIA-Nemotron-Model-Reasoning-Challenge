# v20_corrective_corpus_v178_v176_ciphercrypt12

- created_at: 2026-04-30T17:53:06.429811+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v176 post-twelfth-BIT guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v176 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v178_v176_ciphercrypt12_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v176 stack that already replayed the twelfth cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the twelfth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v178_v176_ciphercrypt12_bundle.jsonl
- base_examples: 7830
- overlay_examples: 49659
- total_examples: 57489
- total_steps: 1797
- total_tokens: 41954092
- max_seq_len: 7971
