# v20_corrective_corpus_v165_v163_numericcrypt10

- created_at: 2026-04-30T17:00:46.320029+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v163 post-tenth-BIT deduce frontier and adds one more numeric operator and quote replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v163 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v165_v163_numericcrypt10_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v163 stack that already replayed the tenth post-BIT crypt deduce pass.
- Add another numeric operator and quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the tenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v165_v163_numericcrypt10_bundle.jsonl
- base_examples: 7830
- overlay_examples: 46747
- total_examples: 54577
- total_steps: 1706
- total_tokens: 40721552
- max_seq_len: 7971
