# v20_corrective_corpus_v220_v218_ciphercrypt20

- created_at: 2026-04-30T20:45:12.125367+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v218 post-nineteenth-crypt frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v218 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v220_v218_ciphercrypt20_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v218 stack that already replayed the latest cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the nineteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v220_v218_ciphercrypt20_bundle.jsonl
- base_examples: 7830
- overlay_examples: 67684
- total_examples: 75514
- total_steps: 2361
- total_tokens: 47121149
- max_seq_len: 7971
