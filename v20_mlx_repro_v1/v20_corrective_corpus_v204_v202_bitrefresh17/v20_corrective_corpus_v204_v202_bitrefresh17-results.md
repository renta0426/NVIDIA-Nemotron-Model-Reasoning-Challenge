# v20_corrective_corpus_v204_v202_bitrefresh17

- created_at: 2026-04-30T19:32:47.889142+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v202 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v202 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v204_v202_bitrefresh17_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v202 stack that already replayed the latest numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v204_v202_bitrefresh17_bundle.jsonl
- base_examples: 7830
- overlay_examples: 61688
- total_examples: 69518
- total_steps: 2173
- total_tokens: 45502089
- max_seq_len: 7971
