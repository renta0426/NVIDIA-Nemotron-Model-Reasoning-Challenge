# v20_corrective_corpus_v193_v191_deducebit15

- created_at: 2026-04-30T18:52:12.002538+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Equation Numeric (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v191 post-fifteenth-BIT frontier and adds one more focused cryptarithm deduce replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v191 recovery stack while re-pressuring the README `Cryptarithm (Deduce)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v193_v191_deducebit15_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v191 stack that already replayed the fifteenth exact-safe BIT pass.
- Add another focused cryptarithm deduce replay so the branch revisits the README `Cryptarithm (Deduce)` slice after the fifteenth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v193_v191_deducebit15_bundle.jsonl
- base_examples: 7830
- overlay_examples: 60341
- total_examples: 68171
- total_steps: 2131
- total_tokens: 44468752
- max_seq_len: 7971
