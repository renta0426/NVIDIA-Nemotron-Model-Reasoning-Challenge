# v20_corrective_corpus_v207_v205_numericcrypt18

- created_at: 2026-04-30T19:45:37.605139+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v205 post-seventeenth-crypt frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v205 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v207_v205_numericcrypt18_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v205 stack that already replayed the latest cryptarithm deduce pass.
- Add another numeric replay so the branch revisits the README `Equation Numeric (Guess)` slice after the seventeenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v207_v205_numericcrypt18_bundle.jsonl
- base_examples: 7830
- overlay_examples: 66151
- total_examples: 73981
- total_steps: 2313
- total_tokens: 46028560
- max_seq_len: 7971
