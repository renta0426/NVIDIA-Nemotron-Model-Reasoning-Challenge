# v20_corrective_corpus_v78_bit_binary_manual_exact_numeric_cipher_guess_deduce_hybrid

- created_at: 2026-04-30T10:27:33.778026+00:00
...
- analysis basis: `README.md` highlights weak base slices in BIT, cipher, numeric-style symbol, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps v75's combined non-BIT support and adds both light guess and low-ratio deduce lanes.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v12 manual-heavy BIT base while testing the full non-BIT lane stack before any further BIT-side changes.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v78_bit_binary_manual_exact_numeric_cipher_guess_deduce_hybrid_mlxdir_mb1_nobc_ckpt20`
...
- Add both the light `cryptarithm_guess` and low-ratio `cryptarithm_deduce` lanes so the new comparison measures the full non-BIT stack on top of the combined numeric/cipher support.
...
- v78_binary_answer_only_manual_exact_numeric_cipher_guess_deduce_hybrid: 307
- v78_binary_manual_full: 438
- v78_binary_verified_manual_exact_numeric_cipher_guess_deduce_hybrid: 7605
- v78_cipher_heavy: 1253
- v78_crypt_deduce_low_ratio: 509
- v78_crypt_guess_light: 462
- v78_numeric_heavy: 267
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v78_bit_binary_manual_exact_numeric_cipher_guess_deduce_hybrid_bundle.jsonl
- base_examples: 7830
- overlay_examples: 10841
- total_examples: 18671
- total_steps: 584
- total_tokens: 31086908
- max_seq_len: 7971
