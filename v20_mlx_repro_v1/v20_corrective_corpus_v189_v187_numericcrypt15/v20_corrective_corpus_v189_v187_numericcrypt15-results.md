# v20_corrective_corpus_v189_v187_numericcrypt15

- created_at: 2026-04-30T18:39:44.136958+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v187 post-fourteenth-crypt frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v187 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v189_v187_numericcrypt15_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v187 stack that already replayed the latest cryptarithm deduce pass.
- Add another numeric replay so the branch revisits the README `Equation Numeric (Guess)` slice after the fourteenth crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v189_v187_numericcrypt15_bundle.jsonl
- base_examples: 7830
- overlay_examples: 57835
- total_examples: 65665
- total_steps: 2053
- total_tokens: 43754128
- max_seq_len: 7971
