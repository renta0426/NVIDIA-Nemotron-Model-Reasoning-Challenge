# v20_corrective_corpus_v197_v195_bitrefresh16

- created_at: 2026-04-30T19:07:47.463434+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v195 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v195 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v197_v195_bitrefresh16_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v195 stack that already replayed the latest numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v197_v195_bitrefresh16_bundle.jsonl
- base_examples: 7830
- overlay_examples: 62336
- total_examples: 70166
- total_steps: 2193
- total_tokens: 45107665
- max_seq_len: 7971
