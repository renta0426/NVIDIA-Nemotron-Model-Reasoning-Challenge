# v20_corrective_corpus_v232_v230_ciphercrypt22

- created_at: 2026-04-30T21:42:10.177814+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Bit Manipulation`, `Equation Numeric (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v230 post-guess frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v230 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v232_v230_ciphercrypt22_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v230 stack that already replayed the latest cryptarithm guess pass.
- Add another hard-cipher replay so the branch revisits the README `Cipher` slice after the twenty-second numeric/cipher refresh.
...
- v198_bit_exact_boost: 1729
- v200_crypt_guess_heavy_boost: 602
- v202_cipher_unknown123_hard4_boost: 244
- v204_bit_exact_boost: 1729
- v206_crypt_guess_heavy_boost: 602
- v208_cipher_unknown123_hard4_boost: 244
- v210_bit_exact_boost: 1729
- v212_crypt_guess_heavy_boost: 602
- v214_cipher_unknown123_hard4_boost: 244
- v216_bit_exact_boost: 1729
- v218_crypt_guess_heavy_boost: 602
- v220_cipher_unknown123_hard4_boost: 244
- v222_bit_exact_boost: 1729
- v224_crypt_guess_heavy_boost: 602
- v226_cipher_unknown123_hard4_boost: 244
- v228_bit_exact_boost: 1729
- v230_crypt_guess_heavy_boost: 602
- v232_cipher_unknown123_hard4_boost: 244
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v232_v230_ciphercrypt22_bundle.jsonl
- base_examples: 7830
- overlay_examples: 72834
- total_examples: 80664
- total_steps: 2522
- total_tokens: 48597451
- max_seq_len: 7971
