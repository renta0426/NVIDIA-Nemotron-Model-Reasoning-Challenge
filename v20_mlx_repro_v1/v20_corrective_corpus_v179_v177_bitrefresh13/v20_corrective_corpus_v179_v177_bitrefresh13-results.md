# v20_corrective_corpus_v179_v177_bitrefresh13

- created_at: 2026-04-30T17:59:57.389569+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v177 latest numeric/cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v177 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v179_v177_bitrefresh13_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v177 stack that already replayed the latest numeric/cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v179_v177_bitrefresh13_bundle.jsonl
- base_examples: 7830
- overlay_examples: 54020
- total_examples: 61850
- total_steps: 1934
- total_tokens: 42833233
- max_seq_len: 7971
