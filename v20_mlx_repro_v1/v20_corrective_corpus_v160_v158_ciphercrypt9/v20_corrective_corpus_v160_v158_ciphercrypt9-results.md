# v20_corrective_corpus_v160_v158_ciphercrypt9

- created_at: 2026-04-30T16:41:06.032784+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cipher`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, `Equation Numeric (Guess)`, and `Bit Manipulation`. This branch keeps the v158 post-ninth-BIT frontier and adds one more hard-cipher replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v158 recovery stack while re-pressuring the README `Cipher` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v160_v158_ciphercrypt9_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v158 stack that already replayed the ninth crypt guess pass.
- Add another unknown123 hard-cipher replay so the branch revisits the README `Cipher` slice after the ninth post-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v160_v158_ciphercrypt9_bundle.jsonl
- base_examples: 7830
- overlay_examples: 41934
- total_examples: 49764
- total_steps: 1556
- total_tokens: 39739639
- max_seq_len: 7971
