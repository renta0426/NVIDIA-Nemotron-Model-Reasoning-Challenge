# v20_corrective_corpus_v215_v213_bitrefresh19

- created_at: 2026-04-30T20:30:07.797877+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, `Cryptarithm (Deduce)`, and `Cipher`. This branch keeps the v213 post-nineteenth-numeric frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v213 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v215_v213_bitrefresh19_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v213 stack that already replayed the latest numeric pass.
- Add another exact-safe BIT replay so the branch revisits the README `Bit Manipulation` slice after the nineteenth numeric/cipher refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v215_v213_bitrefresh19_bundle.jsonl
- base_examples: 7830
- overlay_examples: 71019
- total_examples: 78849
- total_steps: 2465
- total_tokens: 47436836
- max_seq_len: 7971
