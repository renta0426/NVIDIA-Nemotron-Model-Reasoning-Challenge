# v20_corrective_corpus_v224_v222_guessbit20

- created_at: 2026-04-30T20:59:05.337906+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Cryptarithm (Guess)`, `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v222 post-twentieth-bit frontier and adds one more cryptarithm guess replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v222 recovery stack while re-pressuring the README `Cryptarithm (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v224_v222_guessbit20_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v222 stack that already replayed the latest exact-safe BIT pass.
- Add another cryptarithm guess replay so the branch revisits the README `Cryptarithm (Guess)` slice after the twentieth BIT refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v224_v222_guessbit20_bundle.jsonl
- base_examples: 7830
- overlay_examples: 70015
- total_examples: 77845
- total_steps: 2433
- total_tokens: 47809366
- max_seq_len: 7971
