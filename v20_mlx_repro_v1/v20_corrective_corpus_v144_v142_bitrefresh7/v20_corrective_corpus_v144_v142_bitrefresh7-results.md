# v20_corrective_corpus_v144_v142_bitrefresh7

- created_at: 2026-04-30T15:51:58.731936+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Bit Manipulation`, `Cipher`, `Equation Numeric (Guess)`, `Cryptarithm (Guess)`, and `Cryptarithm (Deduce)`. This branch keeps the v142 post-seventh cipher frontier and adds one more exact-safe BIT replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v142 recovery stack while re-pressuring the README `Bit Manipulation` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v144_v142_bitrefresh7_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v142 stack that already replayed the seventh cipher pass.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v144_v142_bitrefresh7_bundle.jsonl
- base_examples: 7830
- overlay_examples: 35938
- total_examples: 43768
- total_steps: 1369
- total_tokens: 38120579
- max_seq_len: 7971
