# v20_corrective_corpus_v117_v115_numericcrypt2

- created_at: 2026-04-30T14:10:56.270453+00:00
...
- analysis basis: `README.md` highlights especially weak base slices in `Equation Numeric (Guess)`, `Cryptarithm (Deduce)`, `Cryptarithm (Guess)`, `Bit Manipulation`, and `Cipher`. This branch keeps the v115 post-second-BIT deduce frontier and adds one more numeric replay pass.
- local target: current best local300 `0.846667` -> aim for `> 0.9` by preserving the broader v115 recovery stack while re-pressuring the README `Equation Numeric (Guess)` weakness.
- status: bundle generated; model score not yet measured.
- planned run name: `v20_mlx_v117_v115_numericcrypt2_mlxdir_mb1_nobc_ckpt20`
...
- Retain the broader v12 bit-binary mainline core and the v115 stack that already refreshed second-pass exact-safe BIT plus focused crypt deduce pressure.
- Add another numeric operator plus quote replay so the branch revisits the README `Equation Numeric (Guess)` slice after the post-second-BIT crypt refresh.
...
- path: A-Open-ProgressPrizePublication/nemotron/training/sft/MLX/v20_corrective_corpus_v117_v115_numericcrypt2_bundle.jsonl
- base_examples: 7830
- overlay_examples: 24571
- total_examples: 32401
- total_steps: 1013
- total_tokens: 34656400
- max_seq_len: 7971
