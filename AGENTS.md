...
- ローカル検証ベストスコアのパイプラインは新たにフォルダを作って単体の１ファイルとして再実装し、再現性を確認の上、提出要件に合ったsubmission.zipを生成すること。ただし、MLXで実験している場合は、特に互換性を気にせずそのままでOK。
なお、このタスクは今後本番スコア相当0.87, 0.88, 0.89, 0.90 それ以上を達成するごとに実施して.
