...
- 次ステップは、structured byte formula の残る `7 manual + 4 exclude` を contaminated family / singleton family / ambiguous multi-pred に割って詰めるか、symbol では `:` / custom-op / operator-embedded の genuinely manual tail を読むこと。glyph 46 行は、新しい family 仮説が出るまで hold。
