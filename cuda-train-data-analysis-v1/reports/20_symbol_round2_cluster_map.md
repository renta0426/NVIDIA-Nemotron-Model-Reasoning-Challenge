...
- remaining post-mimic-exclusion `symbol_numeric_same_op` rows: `317`
- excluded known/query-only mimic union: `56` rows
...
| - | 2 | False | 1 | 7 | 8373daa8,c7a7b13a,debff779,1bc85bd9,3383d4ec |
...
- The excluded union now removes many dead-end `abs_diff_2d` / `abs_diff_2d_op_suffix` lookalikes before round2 starts.
