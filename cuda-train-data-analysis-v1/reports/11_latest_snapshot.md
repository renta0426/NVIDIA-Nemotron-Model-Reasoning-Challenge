...
- generated_at_utc: `2026-03-25T20:55:17.285848+00:00`
- verified_trace_ready: `5863`
- answer_only_keep: `1080`
- manual_audit_priority: `2528`
- exclude_suspect: `29`
...
| symbol_equation | 1555 | 1.0 | 110 | 109 | 1326 | 10 | 10 | 3.1775 |
...
| --- | --- | --- |
| symbol_numeric_same_op | symbol_equation | 367 |
...
- `symbol_equation/numeric_2x2`: `44` query-only arithmetic lookalikes were rechecked; the remaining slice still stays manual (`39` same-op conflicts, `5` format ambiguities).
