...
RESULTS_MD = VERSION_ROOT / "v20_corrective_corpus_v6_promptlocal_default1_heavy-results.md"
...
DEFAULT_BUNDLE_PATH = TRAINING_SFT_ROOT / "v20_corrective_corpus_v6_promptlocal_default1_heavy_bundle.jsonl"
...
def build_summary(
    ...
    return {
        "version": "v20_corrective_corpus_v6_promptlocal_default1_heavy",
        "created_at": utc_now(),
...
def build_training_bundle(
    ...
    manifest = {
        ...
        "note": (
            ...
            "plus a promptlocal-heavy exact-binary overlay with a heavier anti-default1 pack, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build the v6 promptlocal-default1-heavy corrective corpus for the v20 Kaggle reproduction path, "
    ...
    parser.add_argument("--run-name", default="v6_promptlocal_default1_heavy_default")
...
def main() -> None:
    ...
    report_lines = [
        "# v20 corrective corpus v6 promptlocal-default1-heavy report",
        "",
        "## Purpose",
        "",
