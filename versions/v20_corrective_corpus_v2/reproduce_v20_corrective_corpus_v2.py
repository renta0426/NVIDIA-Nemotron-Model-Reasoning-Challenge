...
RESULTS_MD = VERSION_ROOT / "v20_corrective_corpus_v2-results.md"
...
DEFAULT_BUNDLE_PATH = TRAINING_SFT_ROOT / "v20_corrective_corpus_v2_bundle.jsonl"
...
def build_summary(
    ...
    return {
        "version": "v20_corrective_corpus_v2",
        "created_at": utc_now(),
...
def build_training_bundle(
    ...
    manifest = {
        ...
        "note": (
            ...
            "Includes the full v20 base snapshot plus a budgeted binary+guardrail overlay."
        ),
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build a budget-neutral next-step corpus for the v20 Kaggle reproduction path, "
            "preserving binary gains while restoring easy-family guardrails."
        )
    )
    parser.add_argument("--run-name", default="budgeted_binary_guardrail_default")
...
def main() -> None:
    ...
    report_lines = [
        "# v20 corrective corpus v2 report",
        "",
        "## Purpose",
        "",
        "This bundle keeps the v20 base corpus intact and reallocates a limited token budget toward",
        "binary gains that already showed signal, while adding guardrail anchors for fragile easy families.",
        "",
