...
def run_package_peft(args: argparse.Namespace) -> None:
    ...
    submission_path = out_dir / 'submission_manifest_v4.json'
    compatibility_submission_path = out_dir / 'submission_manifest_v3.json'
    ...
    compatibility_submission_path.write_text(manifest_text, encoding='utf-8')
