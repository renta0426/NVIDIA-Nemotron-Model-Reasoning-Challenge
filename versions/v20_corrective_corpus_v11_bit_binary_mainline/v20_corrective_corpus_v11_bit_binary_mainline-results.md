...
- status: bundle generated and parallel MLX training is running; step 2 has completed but model score is not yet measured.
- planned run name: `v20_mlx_v11_bit_binary_mainline_mlxdir_mb1_nobc_ckpt20`
- runtime status: `running`
- latest observed step: `step 3 in progress (step2 loss=0.364683 elapsed=9210.35s tokens=91684)`
