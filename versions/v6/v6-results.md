...
- script: `versions/v6/code/train_transformers_submission_v6.py`
...
- current repo snapshot has no `versions/v6/outputs/` tree
- current repo snapshot also has no version-local Git-managed measured-score artifact under `versions/v6/`
