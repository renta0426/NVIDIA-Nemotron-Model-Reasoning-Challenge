...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_bit_fullband_heavy_expanded"
...
BIT_V4_CURRENT_FULLBAND_MISS_IDS = {
    "000b53cf","00890aff","012fb81b","01e09228","0245b9bb","02a66bcb","0311b798","048cc279","04d8c3e6","053f87d3",
    "05ca617c","06120e47","06881e47","06b5da9f","07d61ec8","07e8cf66","0b56b953","0e70c867","0ec17d2e",
}
BIT_V4_CURRENT_FULLBAND_MISS_EXTRA_REPEAT = 2
...
def build_supervision_variants(candidate: Candidate, base_variant_count: int) -> list[dict[str, str]]:
    ...
    if candidate.row["id"] in BIT_V4_CURRENT_FULLBAND_MISS_IDS and candidate.bucket.startswith("surface_binary_"):
        base_variant_count += BIT_V4_CURRENT_FULLBAND_MISS_EXTRA_REPEAT
...
def build_budgeted_candidates(bucket_limits: dict[str, int]) -> tuple[list[Candidate], dict[str, Any]]:
    ...
    diagnostics = {
        ...
        "v4_live_partial_bit_current_fullband_miss_support_ids": sorted(BIT_V4_CURRENT_FULLBAND_MISS_IDS),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="v6_frontier_bit_fullband_heavy_expanded_default")
