...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_crypt_ruleunknown_heavy_expanded"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="v6_frontier_crypt_ruleunknown_heavy_expanded_default")
