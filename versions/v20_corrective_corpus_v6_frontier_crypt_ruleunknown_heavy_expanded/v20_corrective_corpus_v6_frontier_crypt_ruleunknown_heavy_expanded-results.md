...
- Generator: `versions/v20_corrective_corpus_v6_frontier_crypt_ruleunknown_heavy_expanded/reproduce_v20_corrective_corpus_v6_frontier_crypt_ruleunknown_heavy_expanded.py`
...
- Local regeneration status: `uv run python versions/v20_corrective_corpus_v6_frontier_crypt_ruleunknown_heavy_expanded/reproduce_v20_corrective_corpus_v6_frontier_crypt_ruleunknown_heavy_expanded.py --write-training-bundle` で canonical checks を通して bundle 再生成に成功
