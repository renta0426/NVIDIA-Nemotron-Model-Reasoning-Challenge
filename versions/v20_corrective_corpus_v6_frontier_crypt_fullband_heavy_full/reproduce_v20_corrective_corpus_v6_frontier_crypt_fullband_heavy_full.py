...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_crypt_fullband_heavy_full"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="v6_frontier_crypt_fullband_heavy_full_default")
