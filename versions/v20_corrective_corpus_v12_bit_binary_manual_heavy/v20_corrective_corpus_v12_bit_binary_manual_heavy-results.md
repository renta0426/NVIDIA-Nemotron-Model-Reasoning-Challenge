...
- status: bundle generated and parallel MLX training is running; step 1 has completed but model score is not yet measured.
- planned run name: `v20_mlx_v12_bit_binary_manual_heavy_mlxdir_mb1_nobc_ckpt20`
- runtime status: `running`
- latest observed step: `step 2 in progress (step1 loss=0.383533 elapsed=8533.46s tokens=104262)`
