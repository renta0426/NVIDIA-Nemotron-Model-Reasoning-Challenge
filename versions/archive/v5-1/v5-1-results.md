...
- script: `versions/v5-1/code/train_transformers_submission_v5_1.py`
...
- current repo snapshot has no `versions/v5-1/outputs/` tree
- current repo snapshot also has no version-local Git-managed measured-score artifact under `versions/v5-1/`
