...
- Live MLX snapshot: train `step 55`, trained tokens `6041082`, peak memory `221.9409 GB` (latest polled snapshot did not include a fresh loss field; last recorded non-null loss before this was `0.0021125080239912876` at step `52`)
