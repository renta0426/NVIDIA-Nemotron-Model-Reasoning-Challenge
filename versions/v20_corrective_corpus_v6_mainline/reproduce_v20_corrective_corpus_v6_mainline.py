...
RESULTS_MD = VERSION_ROOT / "v20_corrective_corpus_v6_mainline-results.md"
...
DEFAULT_BUNDLE_PATH = TRAINING_SFT_ROOT / "v20_corrective_corpus_v6_mainline_bundle.jsonl"
...
def build_summary(
    ...
    return {
        "version": "v20_corrective_corpus_v6_mainline",
        "created_at": utc_now(),
...
def build_training_bundle(
    ...
    manifest = {
        ...
        "note": (
            ...
            "plus a v6-core exact-binary multi-lane overlay, anti-default1 reinforcement on hard binary IDs, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build the v6 mainline corrective corpus for the v20 Kaggle reproduction path, "
            "keeping the v20 base, adding exact-binary multi-lane overlays, "
            "and retaining only a minimal boxed-surface stabilizer lane."
        )
    )
    parser.add_argument("--run-name", default="v6_mainline_default")
