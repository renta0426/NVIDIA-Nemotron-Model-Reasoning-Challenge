...
- observed_at: `2026-04-10T14:42:07.199106+00:00`
...
### Pause after training: `nemotron_sft_lora_with_cot_v2_mlx_stagefreeze_v2_stage25_attention_qkvo_reanchor_textv130_bin40proxyo20p0s20_lzpref_grav15_unit15_rowselect_lr8e6_len1024_from_reanchor1024_v1`
...
- training_final: `optimizer_step 12`, `train_loss 0.4585`, `val_loss 0.2645`, `peak_memory 65.4616 GB`
- local320_progress_when_paused: `0/320 = 0.00%`
- verdict: `same/other-bias/repro の 3 lane を優先するため、readme_local320 着手直後で decode を停止`
- note: `local320 / proxy_v1 score は未計測。必要なら current artifacts から later rerun 可能`
