...
- ただし今回のセッション制約では exact CSV materialization は未達:
  - PTY / shell が壊れているため copy/materializer 実行に入れない
  - 使える local reader が `view` / `rg` しかなく、どちらも raw CSV 全文ではなく行番号付き表示 / snippet 表示になる
  - local write primitive は `apply_patch` のみで、既存 80-row artifact CSV を raw のまま複製して所定の 1 row だけ差し替えるための「raw stream / copy」経路が無い
  - そのため `reprobridge35/36` の summary JSON は論理的には組めても、対応する CSV を byte-accurate に新規生成できず、今回は artifact 未出力のまま停止
- 今回はスコア計測・submission 変化なし。次回は raw file copy か non-PTY 実行経路が復旧した時点で、同じ replacement plan をそのまま materialize すればよい
...
- operationally:
  ...
  - actual artifact materialization is still blocked on the global PTY failure, so no `reprobridge35/36` CSV+summary has been emitted yet

Update 2026-04-12T07:50Z:
- `reprobridge27` is now logically unblocked by `reprobridge26` full-suite completion, but the next wave is still not armed:
  - `reprobridge27/28/29/30` all have artifact CSV/summary files in `baseline_mlx/outputs/..._artifacts/`
  - none of `reprobridge27/28/29/30` currently has a downstream run root
  - no `/tmp/reprobridge27*` waiter directory exists, so `27` is not merely stale; it is fully unarmed
- to keep the queue reality Git-visible under the global PTY blocker, `launch_reprobridge31_32_recovery.py --status-report` now also surfaces `reprobridge27/28/29/30` as artifact-only queued runs, instead of only `31/32`
- operational consequence:
  - `reprobridge27` todo is now blocked on shell recovery rather than on `reprobridge26`
  - `reprobridge28/29/30` remain pending behind that same unarmed gap
...
- recorded_at: `2026-04-12T08:57:43.584620+00:00`
...
- recorded_at: `2026-04-12T08:57:46.738598+00:00`
...
- recorded_at: `2026-04-12T08:57:50.340359+00:00`
...
- recorded_at: `2026-04-12T08:57:01.034406+00:00`
...
- recorded_at: `2026-04-12T08:57:23.678550+00:00`
...
- recorded_at: `2026-04-12T08:57:28.323467+00:00`
...
- recorded_at: `2026-04-12T08:57:42.671399+00:00`
...
- recorded_at: `2026-04-12T08:57:47.992789+00:00`
...
- recorded_at: `2026-04-12T08:54:42.237563+00:00`
...
- recorded_at: `2026-04-12T08:57:15.676851+00:00`
...
- recorded_at: `2026-04-12T08:57:04.084765+00:00`
...
- recorded_at: `2026-04-12T08:57:25.731072+00:00`
...
- recorded_at: `2026-04-12T08:57:43.675958+00:00`
...
### Live progress: `nemotron_sft_lora_with_cot_v2_mlx_stagefreeze_v2_stage25_attention_qkvo_reanchor_o30best_proxybench30ao_reprobridge28_text3bit1num8raw9unitedge_lr1e6_len1024_from_proxybench_v1`

- status: `training_completed`
- label: `reprobridge28 raw9 unitedge`
- observed_at: `2026-04-12T08:57:11.477798+00:00`
...
- source_path: `/Users/mac-studio/work/NVIDIA Nemotron Model Reasoning Challenge/baseline_mlx/outputs/nemotron_sft_lora_with_cot_v2_mlx_stagefreeze_v2_stage25_attention_qkvo_reanchor_o30best_proxybench30ao_reprobridge28_text3bit1num8raw9unitedge_lr1e6_len1024_from_proxybench_v1/adapter/latest_train_report.json`
- iteration: `64`
- optimizer_step: `8`
- train_loss: `0.392334`
- learning_rate: `3.80602e-08`
- it_per_sec: `0.964533`
- tokens_per_sec: `498.151`
- trained_tokens: `33054`
