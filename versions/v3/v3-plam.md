...
`submission_v3.zip` は必ず CUDA artifact から作る。
...
11. 10 の通過 candidate を `submission_v3.zip` 化して leaderboard に送る
...
- `submission_v3.zip` が CUDA artifact から出る
