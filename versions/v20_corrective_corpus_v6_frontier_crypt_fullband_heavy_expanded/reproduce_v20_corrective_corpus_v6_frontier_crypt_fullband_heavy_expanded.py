...
VERSION_NAME = "v20_corrective_corpus_v6_frontier_crypt_fullband_heavy_expanded"
...
CRYPT_V4_CURRENT_FULLBAND_MISS_IDS = {
    "00457d26","00c032a8","012cab1f","017a871e","01b2aa67","01ef1e3e","022c4d73","02664ad5","02902eb3","02c15453",
    "02e871e4","035c4c40","03a3437f","042f1e53","0454705a","05109055","053b4c86","055a8b01","05bd2dab","05c36467",
    "06083e68","0625f633","08111d57","083ed8fe","09d5ee68","0a2b9109","0a3ee7c7","0a94b2de","0b0a3643","0babcba2",
    "0bb591e6","0c0c6320","0c30f561","0cdb0aae","0cf301cf","0d2e94ff","0d542478","0d90736f","0dce4039","0df82d52",
    "0e009c6d","0e2d6796","0e3307ba","0e375364","0f01cece",
}
CRYPT_V4_CURRENT_FULLBAND_MISS_EXTRA_REPEAT = 2
...
def build_supervision_variants(candidate: Candidate, base_variant_count: int) -> list[dict[str, str]]:
    ...
    if candidate.row["id"] in CRYPT_V4_CURRENT_FULLBAND_MISS_IDS and candidate.bucket == "surface_cryptarithm_answer_only":
        base_variant_count += CRYPT_V4_CURRENT_FULLBAND_MISS_EXTRA_REPEAT
...
def build_budgeted_candidates(bucket_limits: dict[str, int]) -> tuple[list[Candidate], dict[str, Any]]:
    ...
    diagnostics = {
        ...
        "v4_live_partial_crypt_current_fullband_miss_support_ids": sorted(CRYPT_V4_CURRENT_FULLBAND_MISS_IDS),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="v6_frontier_crypt_fullband_heavy_expanded_default")
