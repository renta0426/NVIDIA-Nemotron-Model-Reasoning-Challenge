...
- script: `versions/v5/code/train_transformers_submission_v5.py`
- portfolio note: `versions/archive/plan-overview.md` still names this file as the historical submission-compatible main line
...
- current repo snapshot has no `versions/v5/outputs/` tree
- current repo snapshot also has no version-local Git-managed measured-score artifact under `versions/v5/`
